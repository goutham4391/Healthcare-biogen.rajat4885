...
(function(d){"function"==typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function O(a,b){var c,e,f,g=a.nodeName.toLowerCase();return"area"===g?(c=a.parentNode,e=c.name,a.href&&e&&"map"===c.nodeName.toLowerCase()?(f=d("img[usemap\x3d'#"+e+"']")[0],!!f&&P(f)):!1):(/^(input|select|textarea|button|object)$/.test(g)?!a.disabled:"a"===g?a.href||b:b)&&P(a)}function P(a){return d.expr.filters.visible(a)&&!d(a).parents().addBack().filter(function(){return"hidden"===d.css(this,"visibility")}).length}
function W(a){for(var b,c;a.length&&a[0]!==document;){if(b=a.css("position"),("absolute"===b||"relative"===b||"fixed"===b)&&(c=parseInt(a.css("zIndex"),10),!isNaN(c)&&0!==c))return c;a=a.parent()}return 0}function Q(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass="ui-datepicker-append";this._triggerClass="ui-datepicker-trigger";this._dialogClass="ui-datepicker-dialog";
...
"mouseover",S)}function S(){d.datepicker._isDisabledDatepicker(D.inline?D.dpDiv.parent()[0]:D.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))}function H(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function F(a){return function(){var b=
...
a)}}):function(a,b,c){return!!d.data(a,c[3])},focusable:function(a){return O(a,!isNaN(d.attr(a,"tabindex")))},tabbable:function(a){var b=d.attr(a,"tabindex"),c=isNaN(b);return(c||0<=b)&&O(a,!c)}});d("\x3ca\x3e").outerWidth(1).jquery||d.each(["Width","Height"],function(a,b){function c(a,b,c,f){return d.each(e,function(){b-=parseFloat(d.css(a,"padding"+this))||0;c&&(b-=parseFloat(d.css(a,"border"+this+"Width"))||0);f&&(b-=parseFloat(d.css(a,"margin"+this))||0)}),b}var e="Width"===b?["Left","Right"]:
...
d.ui.plugin={add:function(a,b,c){var e;a=d.ui[a].prototype;for(e in c)a.plugins[e]=a.plugins[e]||[],a.plugins[e].push([b,c[e]])},call:function(a,b,c,d){if((b=a.plugins[b])&&(d||a.element[0].parentNode&&11!==a.element[0].parentNode.nodeType))for(d=0;b.length>d;d++)a.options[b[d][0]]&&b[d][1].apply(a.element,c)}};var X=0,T=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,e,f;for(f=0;null!=(e=b[f]);f++)try{(c=d._data(e,"events"))&&c.remove&&d(e).triggerHandler("remove")}catch(g){}a(b)}}(d.cleanData);
d.widget=function(a,b,c){var e,f,g,h,k={},l=a.split(".")[0];return a=a.split(".")[1],e=l+"-"+a,c||(c=b,b=d.Widget),d.expr[":"][e.toLowerCase()]=function(a){return!!d.data(a,e)},d[l]=d[l]||{},f=d[l][a],g=d[l][a]=function(a,b){return this._createWidget?(arguments.length&&this._createWidget(a,b),void 0):new g(a,b)},d.extend(g,f,{version:c.version,_proto:d.extend({},c),_childConstructors:[]}),h=new b,h.options=d.widget.extend({},h.options),d.each(c,function(a,c){return d.isFunction(c)?(k[a]=function(){var d=
...
"."+a.widgetName,g,b._proto)}),delete f._childConstructors):b._childConstructors.push(g),d.widget.bridge(a,g),g};d.widget.extend=function(a){for(var b,c,e=T.call(arguments,1),f=0,g=e.length;g>f;f++)for(b in e[f])c=e[f][b],e[f].hasOwnProperty(b)&&void 0!==c&&(a[b]=d.isPlainObject(c)?d.isPlainObject(a[b])?d.widget.extend({},a[b],c):d.widget.extend({},c):c);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(e){var f="string"==typeof e,g=T.call(arguments,1),h=
this;return f?this.each(function(){var b,f=d.data(this,c);return"instance"===e?(h=f,!1):f?d.isFunction(f[e])&&"_"!==e.charAt(0)?(b=f[e].apply(f,g),b!==f&&void 0!==b?(h=b&&b.jquery?h.pushStack(b.get()):b,!1):void 0):d.error("no such method '"+e+"' for "+a+" widget instance"):d.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+e+"'")}):(g.length&&(e=d.widget.extend.apply(null,[e].concat(g))),this.each(function(){var a=d.data(this,c);a?(a.option(e||{}),a._init&&
a._init()):d.data(this,c,new b(e,this))})),h}};d.Widget=function(){};d.Widget._childConstructors=[];d.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"\x3cdiv\x3e",options:{disabled:!1,create:null},_createWidget:function(a,b){b=d(b||this.defaultElement||this)[0];this.element=d(b);this.uuid=X++;this.eventNamespace="."+this.widgetName+this.uuid;this.bindings=d();this.hoverable=d();this.focusable=d();b!==this&&(d.data(b,this.widgetFullName,this),this._on(!0,this.element,{remove:function(a){a.target===
...
m=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,q=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,e=d("\x3cdiv style\x3d'display:block;position:absolute;width:50px;height:50px;overflow:hidden;'\x3e\x3cdiv style\x3d'height:100px;width:auto;'\x3e\x3c/div\x3e\x3c/div\x3e"),f=e.children()[0];return d("body").append(e),a=f.offsetWidth,e.css("overflow","scroll"),b=f.offsetWidth,a===b&&(b=e[0].clientWidth),e.remove(),c=a-b},getScrollInfo:function(a){var b=a.isWindow||a.isDocument?
...
width:b||c?a.width():a.outerWidth(),height:b||c?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var r,u,x,y,t,p,w=d(c.of),B=d.position.getWithinInfo(c.within),C=d.position.getScrollInfo(B),I=(c.collision||"flip").split(" "),L={};return p=b(w),w[0].preventDefault&&(c.at="left top"),u=p.width,x=p.height,y=p.offset,t=d.extend({},y),d.each(["my","at"],function(){var a=(c[this]||"").split(" ");1===a.length&&(a=k.test(a[0])?a.concat(["center"]):
l.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";var b=m.exec(a[0]);var d=m.exec(a[1]);L[this]=[b?b[0]:0,d?d[0]:0];c[this]=[n.exec(a[0])[0],n.exec(a[1])[0]]}),1===I.length&&(I[1]=I[0]),"right"===c.at[0]?t.left+=u:"center"===c.at[0]&&(t.left+=u/2),"bottom"===c.at[1]?t.top+=x:"center"===c.at[1]&&(t.top+=x/2),r=a(L.at,u,x),t.left+=r[0],t.top+=r[1],this.each(function(){var b,k=d(this),l=k.outerWidth(),m=k.outerHeight(),n=parseInt(d.css(this,
"marginLeft"),10)||0,q=parseInt(d.css(this,"marginTop"),10)||0,p=l+n+(parseInt(d.css(this,"marginRight"),10)||0)+C.width,z=m+q+(parseInt(d.css(this,"marginBottom"),10)||0)+C.height,v=d.extend({},t),J=a(L.my,k.outerWidth(),k.outerHeight());"right"===c.my[0]?v.left-=l:"center"===c.my[0]&&(v.left-=l/2);"bottom"===c.my[1]?v.top-=m:"center"===c.my[1]&&(v.top-=m/2);v.left+=J[0];v.top+=J[1];e||(v.left=h(v.left),v.top=h(v.top));var D={marginLeft:n,marginTop:q};d.each(["left","top"],function(a,b){d.ui.position[I[a]]&&
d.ui.position[I[a]][b](v,{targetWidth:u,targetHeight:x,elemWidth:l,elemHeight:m,collisionPosition:D,collisionWidth:p,collisionHeight:z,offset:[r[0]+J[0],r[1]+J[1]],my:c.my,at:c.at,within:B,elem:k})});c.using&&(b=function(a){var b=y.left-v.left,d=b+u-l,e=y.top-v.top,h=e+x-m,r={target:{element:w,left:y.left,top:y.top,width:u,height:x},element:{element:k,left:v.left,top:v.top,width:l,height:m},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};l>u&&u>g(b+d)&&(r.horizontal=
"center");m>x&&x>g(e+h)&&(r.vertical="middle");r.important=f(g(b),g(d))>f(g(e),g(h))?"horizontal":"vertical";c.using.call(this,a,r)});k.offset(d.extend(v,{using:b}))})};d.ui.position={fit:{left:function(a,b){var c,d=b.within,e=d.isWindow?d.scrollLeft:d.offset.left;d=d.width;var g=a.left-b.collisionPosition.marginLeft,h=e-g,k=g+b.collisionWidth-d-e;b.collisionWidth>d?0<h&&0>=k?(c=a.left+h+b.collisionWidth-d-e,a.left+=h-c):a.left=0<k&&0>=h?e:h>k?e+d-b.collisionWidth:e:0<h?a.left+=h:0<k?a.left-=k:a.left=
f(a.left-g,a.left)},top:function(a,b){var c,d=b.within;d=d.isWindow?d.scrollTop:d.offset.top;var e=b.within.height,g=a.top-b.collisionPosition.marginTop,h=d-g,k=g+b.collisionHeight-e-d;b.collisionHeight>e?0<h&&0>=k?(c=a.top+h+b.collisionHeight-e-d,a.top+=h-c):a.top=0<k&&0>=h?d:h>k?d+e-b.collisionHeight:d:0<h?a.top+=h:0<k?a.top-=k:a.top=f(a.top-g,a.top)}},flip:{left:function(a,b){var c,d,e=b.within,f=e.offset.left+e.scrollLeft,h=e.width;e=e.isWindow?e.scrollLeft:e.offset.left;var k=a.left-b.collisionPosition.marginLeft,
l=k-e;k=k+b.collisionWidth-h-e;var r="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,m="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,n=-2*b.offset[0];0>l?(c=a.left+r+m+n+b.collisionWidth-h-f,(0>c||g(l)>c)&&(a.left+=r+m+n)):0<k&&(d=a.left-b.collisionPosition.marginLeft+r+m+n-e,(0<d||k>g(d))&&(a.left+=r+m+n))},top:function(a,b){var c,d,e=b.within,f=e.offset.top+e.scrollTop,h=e.height;e=e.isWindow?e.scrollTop:e.offset.top;var k=a.top-b.collisionPosition.marginTop,l=
k-e;k=k+b.collisionHeight-h-e;var r="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,m="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,n=-2*b.offset[1];0>l?(d=a.top+r+m+n+b.collisionHeight-h-f,(0>d||g(l)>d)&&(a.top+=r+m+n)):0<k&&(c=a.top-b.collisionPosition.marginTop+r+m+n-e,(0<c||k>g(c))&&(a.top+=r+m+n))}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,
arguments);d.ui.position.fit.top.apply(this,arguments)}}};(function(){var a,b=document.getElementsByTagName("body")[0];var c=document.createElement("div");var f=document.createElement(b?"div":"body");var g={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};b&&d.extend(g,{position:"absolute",left:"-1000px",top:"-1000px"});for(a in g)f.style[a]=g[a];f.appendChild(c);g=b||document.documentElement;g.insertBefore(f,g.firstChild);c.style.cssText="position: absolute; left: 10.7432222px;";
c=d(c).offset().left;e=10<c&&11>c;f.innerHTML="";g.removeChild(f)})()})();d.ui.position;d.widget("ui.accordion",{version:"1.11.4",options:{active:0,animate:{},collapsible:!1,event:"click",header:"\x3e li \x3e :first-child,\x3e :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},showProps:{borderTopWidth:"show",
...
0);this._createIcons();this._setupEvents(b.event);"fill"===c?(a=e.height(),this.element.siblings(":visible").each(function(){var b=d(this),c=b.css("position");"absolute"!==c&&"fixed"!==c&&(a-=b.outerHeight(!0))}),this.headers.each(function(){a-=d(this).outerHeight(!0)}),this.headers.next().each(function(){d(this).height(Math.max(0,a-d(this).innerHeight()+d(this).height()))}).css("overflow","auto")):"auto"===c&&(a=0,this.headers.next().each(function(){a=Math.max(a,d(this).css("height","").height())}).height(a))},
...
c.attr({"aria-hidden":"true"});c.prev().attr({"aria-selected":"false","aria-expanded":"false"});b.length&&c.length?c.prev().attr({tabIndex:-1,"aria-expanded":"false"}):b.length&&this.headers.filter(function(){return 0===parseInt(d(this).attr("tabIndex"),10)}).attr("tabIndex",-1);b.attr("aria-hidden","false").prev().attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_animate:function(a,b,c){var d,f,g,h=this,k=0,l=a.css("box-sizing"),m=a.length&&(!b.length||a.index()<b.index()),n=this.options.animate||
{};m=m&&n.down||n;var p=function(){h._toggleComplete(c)};return"number"==typeof m&&(g=m),"string"==typeof m&&(f=m),f=f||m.easing||n.easing,g=g||m.duration||n.duration,b.length?a.length?(d=a.show().outerHeight(),b.animate(this.hideProps,{duration:g,easing:f,step:function(a,b){b.now=Math.round(a)}}),a.hide().animate(this.showProps,{duration:g,easing:f,complete:p,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?"content-box"===l&&(k+=c.now):"content"!==h.options.heightStyle&&(c.now=Math.round(d-
b.outerHeight()-k),k=0)}}),void 0):b.animate(this.hideProps,g,f,p):a.animate(this.showProps,g,f,p)},_toggleComplete:function(a){var b=a.oldPanel;b.removeClass("ui-accordion-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}});d.widget("ui.menu",{version:"1.11.4",defaultElement:"\x3cul\x3e",delay:300,options:{icons:{submenu:"ui-icon-carat-1-e"},items:"\x3e *",menus:"ul",position:{my:"left-1 top",
...
(this.active.is("[aria-haspopup\x3d'true']")?this.expand(a):this.select(a))},refresh:function(){var a=this,b=this.options.icons.submenu;var c=this.element.find(this.options.menus);this.element.toggleClass("ui-menu-icons",!!this.element.find(".ui-icon").length);c.filter(":not(.ui-menu)").addClass("ui-menu ui-widget ui-widget-content ui-front").hide().attr({role:this.options.role,"aria-hidden":"true","aria-expanded":"false"}).each(function(){var a=d(this),c=a.parent(),g=d("\x3cspan\x3e").addClass("ui-menu-icon ui-icon "+
...
this.options.messages.noResults,this.liveRegion.children().hide(),d("\x3cdiv\x3e").text(b).appendTo(this.liveRegion))}});d.ui.autocomplete;var K,Z=function(){var a=d(this);setTimeout(function(){a.find(":ui-button").button("refresh")},1)},V=function(a){var b=a.name,c=a.form,e=d([]);return b&&(b=b.replace(/'/g,"\\'"),e=c?d(c).find("[name\x3d'"+b+"'][type\x3dradio]"):d("[name\x3d'"+b+"'][type\x3dradio]",a.ownerDocument).filter(function(){return!this.form})),e};d.widget("ui.button",{version:"1.11.4",
...
"radio"===this.type,e=c?"":"ui-state-active";null===b.label&&(b.label="input"===this.type?this.buttonElement.val():this.buttonElement.html());this._hoverable(this.buttonElement);this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role","button").bind("mouseenter"+this.eventNamespace,function(){b.disabled||this===K&&d(this).addClass("ui-state-active")}).bind("mouseleave"+this.eventNamespace,function(){b.disabled||d(this).removeClass(e)}).bind("click"+this.eventNamespace,
...
d(this).addClass("ui-state-active");a.buttonElement.attr("aria-pressed","true");var c=a.element[0];V(c).not(c).map(function(){return d(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown"+this.eventNamespace,function(){return b.disabled?!1:(d(this).addClass("ui-state-active"),K=this,a.document.one("mouseup",function(){K=null}),void 0)}).bind("mouseup"+this.eventNamespace,function(){return b.disabled?!1:(d(this).removeClass("ui-state-active"),
...
this._autoSize(b),d.data(a,"datepicker",b),b.settings.disabled&&this._disableDatepicker(a))},_attachments:function(a,b){var c,e;var f=this._get(b,"appendText");var g=this._get(b,"isRTL");b.append&&b.append.remove();f&&(b.append=d("\x3cspan class\x3d'"+this._appendClass+"'\x3e"+f+"\x3c/span\x3e"),a[g?"before":"after"](b.append));a.unbind("focus",this._showDatepicker);b.trigger&&b.trigger.remove();f=this._get(b,"showOn");"focus"!==f&&"both"!==f||a.focus(this._showDatepicker);"button"!==f&&"both"!==
f||(c=this._get(b,"buttonText"),e=this._get(b,"buttonImage"),b.trigger=d(this._get(b,"buttonImageOnly")?d("\x3cimg/\x3e").addClass(this._triggerClass).attr({src:e,alt:c,title:c}):d("\x3cbutton type\x3d'button'\x3e\x3c/button\x3e").addClass(this._triggerClass).html(e?d("\x3cimg/\x3e").attr({src:e,alt:c,title:c}):c)),a[g?"before":"after"](b.trigger),b.trigger.click(function(){return d.datepicker._datepickerShowing&&d.datepicker._lastInput===a[0]?d.datepicker._hideDatepicker():d.datepicker._datepickerShowing&&
...
20-g.getDay()));a.input.attr("size",this._formatDate(a,g).length)}},_inlineDatepicker:function(a,b){var c=d(a);c.hasClass(this.markerClassName)||(c.addClass(this.markerClassName).append(b.dpDiv),d.data(a,"datepicker",b),this._setDate(b,this._getDefaultDate(b),!0),this._updateDatepicker(b),this._updateAlternate(b),b.settings.disabled&&this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,e,f){var g,h,k,l,m;a=this._dialogInst;return a||(this.uuid+=1,g="dp"+this.uuid,
this._dialogInput=d("\x3cinput type\x3d'text' id\x3d'"+g+"' style\x3d'position: absolute; top: -100px; width: 0px;'/\x3e"),this._dialogInput.keydown(this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a)),H(a.settings,e||{}),b=b&&b.constructor===Date?this._formatDate(a,b):b,this._dialogInput.val(b),this._pos=f?f.length?f:[f.pageX,f.pageY]:null,this._pos||(h=document.documentElement.clientWidth,
...
d.extend({},k.settings):this._get(k,b):null:(e=b||{},"string"==typeof b&&(e={},e[b]=c),k&&(this._curInst===k&&this._hideDatepicker(),f=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),H(k.settings,e),null!==g&&void 0!==e.dateFormat&&void 0===e.minDate&&(k.settings.minDate=this._formatDate(k,g)),null!==h&&void 0!==e.dateFormat&&void 0===e.maxDate&&(k.settings.maxDate=this._formatDate(k,h)),"disabled"in e&&(e.disabled?this._disableDatepicker(a):this._enableDatepicker(a)),
this._attachments(d(a),k),this._autoSize(k),this._setDate(k,f),this._updateAlternate(k),this._updateDatepicker(k)),void 0)},_changeDatepicker:function(a,b,c){this._optionDatepicker(a,b,c)},_refreshDatepicker:function(a){(a=this._getInst(a))&&this._updateDatepicker(a)},_setDateDatepicker:function(a,b){(a=this._getInst(a))&&(this._setDate(a,b),this._updateDatepicker(a),this._updateAlternate(a))},_getDateDatepicker:function(a,b){a=this._getInst(a);return a&&!a.inline&&this._setDateFromField(a,b),a?this._getDate(a):
null},_doKeyDown:function(a){var b,c,e,f=d.datepicker._getInst(a.target),g=!0,h=f.dpDiv.is(".ui-datepicker-rtl");if(f._keyEvent=!0,d.datepicker._datepickerShowing)switch(a.keyCode){case 9:d.datepicker._hideDatepicker();g=!1;break;case 13:return e=d("td."+d.datepicker._dayOverClass+":not(."+d.datepicker._currentClass+")",f.dpDiv),e[0]&&d.datepicker._selectDay(a.target,f.selectedMonth,f.selectedYear,e[0]),b=d.datepicker._get(f,"onSelect"),b?(c=d.datepicker._formatDate(f),b.apply(f.input?f.input[0]:
null,[c,f])):d.datepicker._hideDatepicker(),!1;case 27:d.datepicker._hideDatepicker();break;case 33:d.datepicker._adjustDate(a.target,a.ctrlKey?-d.datepicker._get(f,"stepBigMonths"):-d.datepicker._get(f,"stepMonths"),"M");break;case 34:d.datepicker._adjustDate(a.target,a.ctrlKey?+d.datepicker._get(f,"stepBigMonths"):+d.datepicker._get(f,"stepMonths"),"M");break;case 35:(a.ctrlKey||a.metaKey)&&d.datepicker._clearDate(a.target);g=a.ctrlKey||a.metaKey;break;case 36:(a.ctrlKey||a.metaKey)&&d.datepicker._gotoToday(a.target);
g=a.ctrlKey||a.metaKey;break;case 37:(a.ctrlKey||a.metaKey)&&d.datepicker._adjustDate(a.target,h?1:-1,"D");g=a.ctrlKey||a.metaKey;a.originalEvent.altKey&&d.datepicker._adjustDate(a.target,a.ctrlKey?-d.datepicker._get(f,"stepBigMonths"):-d.datepicker._get(f,"stepMonths"),"M");break;case 38:(a.ctrlKey||a.metaKey)&&d.datepicker._adjustDate(a.target,-7,"D");g=a.ctrlKey||a.metaKey;break;case 39:(a.ctrlKey||a.metaKey)&&d.datepicker._adjustDate(a.target,h?-1:1,"D");g=a.ctrlKey||a.metaKey;a.originalEvent.altKey&&
...
a.target||a,"input"!==a.nodeName.toLowerCase()&&(a=d("input",a.parentNode)[0]),!d.datepicker._isDisabledDatepicker(a)&&d.datepicker._lastInput!==a){var b,c,e,f;var g=d.datepicker._getInst(a);d.datepicker._curInst&&d.datepicker._curInst!==g&&(d.datepicker._curInst.dpDiv.stop(!0,!0),g&&d.datepicker._datepickerShowing&&d.datepicker._hideDatepicker(d.datepicker._curInst.input[0]));var h=(h=d.datepicker._get(g,"beforeShow"))?h.apply(a,[a,g]):{};!1!==h&&(H(g.settings,h),g.lastVal=null,d.datepicker._lastInput=
a,d.datepicker._setDateFromField(g),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),b=!1,d(a).parents().each(function(){return b|="fixed"===d(this).css("position"),!b}),c={left:d.datepicker._pos[0],top:d.datepicker._pos[1]},d.datepicker._pos=null,g.dpDiv.empty(),g.dpDiv.css({position:"absolute",display:"block",top:"-1000px"}),d.datepicker._updateDatepicker(g),c=d.datepicker._checkOffset(g,c,b),g.dpDiv.css({position:d.datepicker._inDialog&&
d.blockUI?"static":b?"fixed":"absolute",display:"none",left:c.left+"px",top:c.top+"px"}),g.inline||(e=d.datepicker._get(g,"showAnim"),f=d.datepicker._get(g,"duration"),g.dpDiv.css("z-index",W(d(a))+1),d.datepicker._datepickerShowing=!0,d.effects&&d.effects.effect[e]?g.dpDiv.show(e,d.datepicker._get(g,"showOptions"),f):g.dpDiv[e||"show"](e?f:null),d.datepicker._shouldFocusInput(g)&&g.input.focus(),d.datepicker._curInst=g))}},_updateDatepicker:function(a){this.maxRows=4;D=a;a.dpDiv.empty().append(this._generateHTML(a));
this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),e=c[1],f=a.dpDiv.find("."+this._dayOverClass+" a");0<f.length&&S.apply(f.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<e&&a.dpDiv.addClass("ui-datepicker-multi-"+e).css("width",17*e+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");a.dpDiv[(this._get(a,"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");a===d.datepicker._curInst&&d.datepicker._datepickerShowing&&
...
(c?0:d(document).scrollLeft()),l=document.documentElement.clientHeight+(c?0:d(document).scrollTop());return b.left-=this._get(a,"isRTL")?e-g:0,b.left-=c&&b.left===a.input.offset().left?d(document).scrollLeft():0,b.top-=c&&b.top===a.input.offset().top+h?d(document).scrollTop():0,b.left-=Math.min(b.left,b.left+e>k&&k>e?Math.abs(b.left+e-k):0),b.top-=Math.min(b.top,b.top+f>l&&l>f?Math.abs(f+h):0),b},_findPos:function(a){var b,c=this._getInst(a);for(c=this._get(c,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||
d.expr.filters.hidden(a));)a=a[c?"previousSibling":"nextSibling"];return b=d(a).offset(),[b.left,b.top]},_hideDatepicker:function(a){var b,c,e,f,g=this._curInst;!g||a&&g!==d.data(a,"datepicker")||this._datepickerShowing&&(b=this._get(g,"showAnim"),c=this._get(g,"duration"),e=function(){d.datepicker._tidyDialog(g)},d.effects&&(d.effects.effect[b]||d.effects[b])?g.dpDiv.hide(b,d.datepicker._get(g,"showOptions"),c,e):g.dpDiv["slideDown"===b?"slideUp":"fadeIn"===b?"fadeOut":"hide"](b?c:null,e),b||e(),
this._datepickerShowing=!1,f=this._get(g,"onClose"),f&&f.apply(g.input?g.input[0]:null,[g.input?g.input.val():"",g]),this._lastInput=null,this._inDialog&&(this._dialogInput.css({position:"absolute",left:"0",top:"-100px"}),d.blockUI&&(d.unblockUI(),d("body").append(this.dpDiv))),this._inDialog=!1)},_tidyDialog:function(a){a.dpDiv.removeClass(this._dialogClass).unbind(".ui-datepicker-calendar")},_checkExternalClick:function(a){if(d.datepicker._curInst){a=d(a.target);var b=d.datepicker._getInst(a[0]);
...
"altFormat")||this._get(a,"dateFormat"),c=this._getDate(a),e=this.formatDate(b,c,this._getFormatConfig(a)),d(f).each(function(){d(this).val(e)}))},noWeekends:function(a){a=a.getDay();return[0<a&&6>a,""]},iso8601Week:function(a){var b;a=new Date(a.getTime());return a.setDate(a.getDate()+4-(a.getDay()||7)),b=a.getTime(),a.setMonth(0),a.setDate(1),Math.floor(Math.round((b-a)/864E5)/7)+1},parseDate:function(a,b,c){if(null==a||null==b)throw"Invalid arguments";if(b="object"==typeof b?""+b:b+"",""===b)return null;
var e,f,g,h=0,k=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff;k="string"!=typeof k?k:(new Date).getFullYear()%100+parseInt(k,10);var l=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,m=(c?c.dayNames:null)||this._defaults.dayNames,n=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var p=-1,q=-1,t=-1,r=-1,u=!1,x=function(b){b=a.length>e+1&&a.charAt(e+1)===b;return b&&e++,b},y=function(a){var c=x(a);c="@"===a?14:"!"===a?
20:"y"===a&&c?4:"o"===a?3:2;a=RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(h).match(a);if(!a)throw"Missing number at position "+h;return h+=a[0].length,parseInt(a[0],10)},z=function(a,c,e){var f=-1;a=d.map(x(a)?e:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});if(d.each(a,function(a,c){a=c[1];return b.substr(h,a.length).toLowerCase()===a.toLowerCase()?(f=c[0],h+=a.length,!1):void 0}),-1!==f)return f+1;throw"Unknown name at position "+h;},v=function(){if(b.charAt(h)!==
a.charAt(e))throw"Unexpected literal at position "+h;h++};for(e=0;a.length>e;e++)if(u)"'"!==a.charAt(e)||x("'")?v():u=!1;else switch(a.charAt(e)){case "d":t=y("d");break;case "D":z("D",l,m);break;case "o":r=y("o");break;case "m":q=y("m");break;case "M":q=z("M",n,c);break;case "y":p=y("y");break;case "@":var w=new Date(y("@"));p=w.getFullYear();q=w.getMonth()+1;t=w.getDate();break;case "!":w=new Date((y("!")-this._ticksTo1970)/1E4);p=w.getFullYear();q=w.getMonth()+1;t=w.getDate();break;case "'":x("'")?
v():u=!0;break;default:v()}if(b.length>h&&(g=b.substr(h),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;if(-1===p?p=(new Date).getFullYear():100>p&&(p+=(new Date).getFullYear()-(new Date).getFullYear()%100+(k>=p?0:-100)),-1<r)for(q=1,t=r;!(f=this._getDaysInMonth(p,q-1),f>=t);)q++,t-=f;if(w=this._daylightSavingAdjust(new Date(p,q-1,t)),w.getFullYear()!==p||w.getMonth()+1!==q||w.getDate()!==t)throw"Invalid date";return w},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",
RFC_822:"D, d M y",RFC_850:"DD, dd-M-y",RFC_1036:"D, d M y",RFC_1123:"D, d M yy",RFC_2822:"D, d M yy",RSS:"D, d M y",TICKS:"!",TIMESTAMP:"@",W3C:"yy-mm-dd",_ticksTo1970:864E9*719162,formatDate:function(a,b,c){if(!b)return"";var d,f=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,g=(c?c.dayNames:null)||this._defaults.dayNames,h=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var k=function(b){b=a.length>d+1&&a.charAt(d+1)===b;return b&&
d++,b},l=function(a,b,c){b=""+b;if(k(a))for(;c>b.length;)b="0"+b;return b},m=function(a,b,c,d){return k(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;a.length>d;d++)if(p)"'"!==a.charAt(d)||k("'")?n+=a.charAt(d):p=!1;else switch(a.charAt(d)){case "d":n+=l("d",b.getDate(),2);break;case "D":n+=m("D",b.getDay(),f,g);break;case "o":n+=l("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":n+=l("m",b.getMonth()+1,2);break;
case "M":n+=m("M",b.getMonth(),h,c);break;case "y":n+=k("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":n+=b.getTime();break;case "!":n+=1E4*b.getTime()+this._ticksTo1970;break;case "'":k("'")?n+="'":p=!0;break;default:n+=a.charAt(d)}return n},_possibleChars:function(a){var b,c="",d=!1,f=function(c){c=a.length>b+1&&a.charAt(b+1)===c;return c&&b++,c};for(b=0;a.length>b;b++)if(d)"'"!==a.charAt(b)||f("'")?c+=a.charAt(b):d=!1;else switch(a.charAt(b)){case "d":case "m":case "y":case "@":c+=
...
a.drawYear=a.selectedYear=g.getFullYear();a.currentDay=d?g.getDate():0;a.currentMonth=d?g.getMonth():0;a.currentYear=d?g.getFullYear():0;this._adjustInstDate(a)}},_getDefaultDate:function(a){return this._restrictMinMax(a,this._determineDate(a,this._get(a,"defaultDate"),new Date))},_determineDate:function(a,b,c){var e=function(a){var b=new Date;return b.setDate(b.getDate()+a),b},f=function(b){try{return d.datepicker.parseDate(d.datepicker._get(a,"dateFormat"),b,d.datepicker._getFormatConfig(a))}catch(p){}var c=
...
"\\");a.dpDiv.find("[data-handler]").map(function(){d(this).bind(this.getAttribute("data-event"),{prev:function(){d.datepicker._adjustDate(c,-b,"M")},next:function(){d.datepicker._adjustDate(c,+b,"M")},hide:function(){d.datepicker._hideDatepicker()},today:function(){d.datepicker._gotoToday(c)},selectDay:function(){return d.datepicker._selectDay(c,+this.getAttribute("data-month"),+this.getAttribute("data-year"),this),!1},selectMonth:function(){return d.datepicker._selectMonthYear(c,this,"M"),!1},selectYear:function(){return d.datepicker._selectMonthYear(c,
this,"Y"),!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,d,f,g,h,k,l=new Date;l=this._daylightSavingAdjust(new Date(l.getFullYear(),l.getMonth(),l.getDate()));var m=this._get(a,"isRTL");var n=this._get(a,"showButtonPanel");var p=this._get(a,"hideIfNoPrevNext");var q=this._get(a,"navigationAsDateFormat");var t=this._getNumberOfMonths(a),r=this._get(a,"showCurrentAtPos");var u=this._get(a,"stepMonths");var x=1!==t[0]||1!==t[1],y=this._daylightSavingAdjust(a.currentDay?
new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),z=this._getMinMaxDate(a,"min"),v=this._getMinMaxDate(a,"max");r=a.drawMonth-r;var w=a.drawYear;if(0>r&&(r+=12,w--),v){var B=this._daylightSavingAdjust(new Date(v.getFullYear(),v.getMonth()-t[0]*t[1]+1,v.getDate()));for(B=z&&z>B?z:B;this._daylightSavingAdjust(new Date(w,r,1))>B;)r--,0>r&&(r=11,w--)}a.drawMonth=r;a.drawYear=w;B=this._get(a,"prevText");B=q?this.formatDate(B,this._daylightSavingAdjust(new Date(w,r-u,1)),this._getFormatConfig(a)):
B;B=this._canAdjustMonth(a,-1,w,r)?"\x3ca class\x3d'ui-datepicker-prev ui-corner-all' data-handler\x3d'prev' data-event\x3d'click' title\x3d'"+B+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"e":"w")+"'\x3e"+B+"\x3c/span\x3e\x3c/a\x3e":p?"":"\x3ca class\x3d'ui-datepicker-prev ui-corner-all ui-state-disabled' title\x3d'"+B+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"e":"w")+"'\x3e"+B+"\x3c/span\x3e\x3c/a\x3e";var C=this._get(a,"nextText");C=q?this.formatDate(C,this._daylightSavingAdjust(new Date(w,
r+u,1)),this._getFormatConfig(a)):C;p=this._canAdjustMonth(a,1,w,r)?"\x3ca class\x3d'ui-datepicker-next ui-corner-all' data-handler\x3d'next' data-event\x3d'click' title\x3d'"+C+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"w":"e")+"'\x3e"+C+"\x3c/span\x3e\x3c/a\x3e":p?"":"\x3ca class\x3d'ui-datepicker-next ui-corner-all ui-state-disabled' title\x3d'"+C+"'\x3e\x3cspan class\x3d'ui-icon ui-icon-circle-triangle-"+(m?"w":"e")+"'\x3e"+C+"\x3c/span\x3e\x3c/a\x3e";u=this._get(a,"currentText");
C=this._get(a,"gotoCurrent")&&a.currentDay?y:l;u=q?this.formatDate(u,C,this._getFormatConfig(a)):u;q=a.inline?"":"\x3cbutton type\x3d'button' class\x3d'ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler\x3d'hide' data-event\x3d'click'\x3e"+this._get(a,"closeText")+"\x3c/button\x3e";n=n?"\x3cdiv class\x3d'ui-datepicker-buttonpane ui-widget-content'\x3e"+(m?q:"")+(this._isInRange(a,C)?"\x3cbutton type\x3d'button' class\x3d'ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler\x3d'today' data-event\x3d'click'\x3e"+
u+"\x3c/button\x3e":"")+(m?"":q)+"\x3c/div\x3e":"";q=parseInt(this._get(a,"firstDay"),10);q=isNaN(q)?0:q;u=this._get(a,"showWeek");C=this._get(a,"dayNames");var I=this._get(a,"dayNamesMin");var L=this._get(a,"monthNames");var Y=this._get(a,"monthNamesShort");var U=this._get(a,"beforeShowDay");var D=this._get(a,"showOtherMonths");var F=this._get(a,"selectOtherMonths");var H=this._getDefaultDate(a);var G="";for(c=0;t[0]>c;c++){var K="";this.maxRows=4;for(d=0;t[1]>d;d++){if(f=this._daylightSavingAdjust(new Date(w,
r,a.selectedDay)),b=" ui-corner-all",g="",x){if(g+="\x3cdiv class\x3d'ui-datepicker-group",1<t[1])switch(d){case 0:g+=" ui-datepicker-group-first";b=" ui-corner-"+(m?"right":"left");break;case t[1]-1:g+=" ui-datepicker-group-last";b=" ui-corner-"+(m?"left":"right");break;default:g+=" ui-datepicker-group-middle",b=""}g+="'\x3e"}g+="\x3cdiv class\x3d'ui-datepicker-header ui-widget-header ui-helper-clearfix"+b+"'\x3e"+(/all|left/.test(b)&&0===c?m?p:B:"")+(/all|right/.test(b)&&0===c?m?B:p:"")+this._generateMonthYearHeader(a,
r,w,z,v,0<c||0<d,L,Y)+"\x3c/div\x3e\x3ctable class\x3d'ui-datepicker-calendar'\x3e\x3cthead\x3e\x3ctr\x3e";var E=u?"\x3cth class\x3d'ui-datepicker-week-col'\x3e"+this._get(a,"weekHeader")+"\x3c/th\x3e":"";for(b=0;7>b;b++){var A=(b+q)%7;E+="\x3cth scope\x3d'col'"+(5<=(b+q+6)%7?" class\x3d'ui-datepicker-week-end'":"")+"\x3e\x3cspan title\x3d'"+C[A]+"'\x3e"+I[A]+"\x3c/span\x3e\x3c/th\x3e"}g+=E+"\x3c/tr\x3e\x3c/thead\x3e\x3ctbody\x3e";E=this._getDaysInMonth(w,r);w===a.selectedYear&&r===a.selectedMonth&&
(a.selectedDay=Math.min(a.selectedDay,E));b=(this._getFirstDayOfMonth(w,r)-q+7)%7;E=Math.ceil((b+E)/7);this.maxRows=E=x?this.maxRows>E?this.maxRows:E:E;A=this._daylightSavingAdjust(new Date(w,r,1-b));for(h=0;E>h;h++){g+="\x3ctr\x3e";var J=u?"\x3ctd class\x3d'ui-datepicker-week-col'\x3e"+this._get(a,"calculateWeek")(A)+"\x3c/td\x3e":"";for(b=0;7>b;b++){var M=U?U.apply(a.input?a.input[0]:null,[A]):[!0,""];var N=(k=A.getMonth()!==r)&&!F||!M[0]||z&&z>A||v&&A>v;J+="\x3ctd class\x3d'"+(5<=(b+q+6)%7?" ui-datepicker-week-end":
"")+(k?" ui-datepicker-other-month":"")+(A.getTime()===f.getTime()&&r===a.selectedMonth&&a._keyEvent||H.getTime()===A.getTime()&&H.getTime()===f.getTime()?" "+this._dayOverClass:"")+(N?" "+this._unselectableClass+" ui-state-disabled":"")+(k&&!D?"":" "+M[1]+(A.getTime()===y.getTime()?" "+this._currentClass:"")+(A.getTime()===l.getTime()?" ui-datepicker-today":""))+"'"+(k&&!D||!M[2]?"":" title\x3d'"+M[2].replace(/'/g,"\x26#39;")+"'")+(N?"":" data-handler\x3d'selectDay' data-event\x3d'click' data-month\x3d'"+
A.getMonth()+"' data-year\x3d'"+A.getFullYear()+"'")+"\x3e"+(k&&!D?"\x26#xa0;":N?"\x3cspan class\x3d'ui-state-default'\x3e"+A.getDate()+"\x3c/span\x3e":"\x3ca class\x3d'ui-state-default"+(A.getTime()===l.getTime()?" ui-state-highlight":"")+(A.getTime()===y.getTime()?" ui-state-active":"")+(k?" ui-priority-secondary":"")+"' href\x3d'#'\x3e"+A.getDate()+"\x3c/a\x3e")+"\x3c/td\x3e";A.setDate(A.getDate()+1);A=this._daylightSavingAdjust(A)}g+=J+"\x3c/tr\x3e"}r++;11<r&&(r=0,w++);g+="\x3c/tbody\x3e\x3c/table\x3e"+
(x?"\x3c/div\x3e"+(0<t[0]&&d===t[1]-1?"\x3cdiv class\x3d'ui-datepicker-row-break'\x3e\x3c/div\x3e":""):"");K+=g}G+=K}return G+=n,a._keyEvent=!1,G},_generateMonthYearHeader:function(a,b,c,d,f,g,h,k){var e,m=this._get(a,"changeMonth"),n=this._get(a,"changeYear"),p=this._get(a,"showMonthAfterYear"),q="\x3cdiv class\x3d'ui-datepicker-title'\x3e",t="";if(g||!m)t+="\x3cspan class\x3d'ui-datepicker-month'\x3e"+h[b]+"\x3c/span\x3e";else{h=d&&d.getFullYear()===c;var r=f&&f.getFullYear()===c;t+="\x3cselect class\x3d'ui-datepicker-month' data-handler\x3d'selectMonth' data-event\x3d'change'\x3e";
for(e=0;12>e;e++)(!h||e>=d.getMonth())&&(!r||f.getMonth()>=e)&&(t+="\x3coption value\x3d'"+e+"'"+(e===b?" selected\x3d'selected'":"")+"\x3e"+k[e]+"\x3c/option\x3e");t+="\x3c/select\x3e"}if(p||(q+=t+(!g&&m&&n?"":"\x26#xa0;")),!a.yearshtml)if(a.yearshtml="",g||!n)q+="\x3cspan class\x3d'ui-datepicker-year'\x3e"+c+"\x3c/span\x3e";else{k=this._get(a,"yearRange").split(":");var u=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?u+parseInt(a,10):
parseInt(a,10);return isNaN(a)?u:a};b=h(k[0]);k=Math.max(b,h(k[1]||""));b=d?Math.max(b,d.getFullYear()):b;k=f?Math.min(k,f.getFullYear()):k;for(a.yearshtml+="\x3cselect class\x3d'ui-datepicker-year' data-handler\x3d'selectYear' data-event\x3d'change'\x3e";k>=b;b++)a.yearshtml+="\x3coption value\x3d'"+b+"'"+(b===c?" selected\x3d'selected'":"")+"\x3e"+b+"\x3c/option\x3e";a.yearshtml+="\x3c/select\x3e";q+=a.yearshtml;a.yearshtml=null}return q+=this._get(a,"yearSuffix"),p&&(q+=(!g&&m&&n?"":"\x26#xa0;")+
t),q+="\x3c/div\x3e"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),f=a.drawMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,f))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,f,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==c&&"Y"!==c||this._notifyChange(a)},_restrictMinMax:function(a,b){var c=this._getMinMaxDate(a,"min");a=this._getMinMaxDate(a,"max");b=c&&c>
b?c:b;return a&&b>a?a:b},_notifyChange:function(a){var b=this._get(a,"onChangeMonthYear");b&&b.apply(a.input?a.input[0]:null,[a.selectedYear,a.selectedMonth+1,a])},_getNumberOfMonths:function(a){a=this._get(a,"numberOfMonths");return null==a?[1,1]:"number"==typeof a?[1,a]:a},_getMinMaxDate:function(a,b){return this._determineDate(a,this._get(a,b+"Date"),null)},_getDaysInMonth:function(a,b){return 32-this._daylightSavingAdjust(new Date(a,b,32)).getDate()},_getFirstDayOfMonth:function(a,b){return(new Date(a,
b,1)).getDay()},_canAdjustMonth:function(a,b,c,d){var e=this._getNumberOfMonths(a);c=this._daylightSavingAdjust(new Date(c,d+(0>b?b:e[0]*e[1]),1));return 0>b&&c.setDate(this._getDaysInMonth(c.getFullYear(),c.getMonth())),this._isInRange(a,c)},_isInRange:function(a,b){var c,d,f=this._getMinMaxDate(a,"min"),g=this._getMinMaxDate(a,"max"),h=null,k=null;a=this._get(a,"yearRange");return a&&(c=a.split(":"),d=(new Date).getFullYear(),h=parseInt(c[0],10),k=parseInt(c[1],10),c[0].match(/[+\-].*/)&&(h+=d),
c[1].match(/[+\-].*/)&&(k+=d)),(!f||b.getTime()>=f.getTime())&&(!g||b.getTime()<=g.getTime())&&(!h||b.getFullYear()>=h)&&(!k||k>=b.getFullYear())},_getFormatConfig:function(a){var b=this._get(a,"shortYearCutoff");return b="string"!=typeof b?b:(new Date).getFullYear()%100+parseInt(b,10),{shortYearCutoff:b,dayNamesShort:this._get(a,"dayNamesShort"),dayNames:this._get(a,"dayNames"),monthNamesShort:this._get(a,"monthNamesShort"),monthNames:this._get(a,"monthNames")}},_formatDate:function(a,b,c,d){b||
...
d.datepicker=new Q;d.datepicker.initialized=!1;d.datepicker.uuid=(new Date).getTime();d.datepicker.version="1.11.4";d.datepicker;d.widget("ui.draggable",d.ui.mouse,{version:"1.11.4",widgetEventPrefix:"drag",options:{addClasses:!0,appendTo:"parent",axis:!1,connectToSortable:!1,containment:!1,cursor:"auto",cursorAt:!1,grid:!1,handle:!1,helper:"original",iframeFix:!1,opacity:!1,refreshPositions:!1,revert:!1,revertDuration:500,scope:"default",scroll:!0,scrollSensitivity:20,scrollSpeed:20,snap:!1,snapMode:"both",
...
!1!==e&&d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(c,a)}});d.ui.plugin.add("draggable","snap",{start:function(a,b,c){a=c.options;c.snapElements=[];d(a.snap.constructor!==String?a.snap.items||":data(ui-draggable)":a.snap).each(function(){var a=d(this),b=a.offset();this!==c.element[0]&&c.snapElements.push({item:this,width:a.outerWidth(),height:a.outerHeight(),top:b.top,left:b.left})})},drag:function(a,b,c){var e,f,g,h,k,l,m=c.options,n=m.snapTolerance,p=b.offset.left,q=p+c.helperProportions.width,
t=b.offset.top,r=t+c.helperProportions.height;for(k=c.snapElements.length-1;0<=k;k--){var u=c.snapElements[k].left-c.margins.left;var x=u+c.snapElements[k].width;var y=c.snapElements[k].top-c.margins.top;var z=y+c.snapElements[k].height;u-n>q||p>x+n||y-n>r||t>z+n||!d.contains(c.snapElements[k].item.ownerDocument,c.snapElements[k].item)?(c.snapElements[k].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[k].item})),c.snapElements[k].snapping=
!1):("inner"!==m.snapMode&&(e=n>=Math.abs(y-r),f=n>=Math.abs(z-t),g=n>=Math.abs(u-q),h=n>=Math.abs(x-p),e&&(b.position.top=c._convertPositionTo("relative",{top:y-c.helperProportions.height,left:0}).top),f&&(b.position.top=c._convertPositionTo("relative",{top:z,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:u-c.helperProportions.width}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:x}).left)),l=e||f||g||h,"outer"!==m.snapMode&&(e=n>=Math.abs(y-
t),f=n>=Math.abs(z-r),g=n>=Math.abs(u-p),h=n>=Math.abs(x-q),e&&(b.position.top=c._convertPositionTo("relative",{top:y,left:0}).top),f&&(b.position.top=c._convertPositionTo("relative",{top:z-c.helperProportions.height,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:u}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:x-c.helperProportions.width}).left)),!c.snapElements[k].snapping&&(e||f||g||h||l)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,
...
zoom:1,display:"block"})),this.originalElement.css({margin:this.originalElement.css("margin")}),this._proportionallyResize()),this.handles=c.handles||(d(".ui-resizable-handle",this.element).length?{n:".ui-resizable-n",e:".ui-resizable-e",s:".ui-resizable-s",w:".ui-resizable-w",se:".ui-resizable-se",sw:".ui-resizable-sw",ne:".ui-resizable-ne",nw:".ui-resizable-nw"}:"e,s,se"),this._handles=d(),this.handles.constructor===String){"all"===this.handles&&(this.handles="n,e,s,w,se,sw,ne,nw");var e=this.handles.split(",");
this.handles={};for(a=0;e.length>a;a++){var f=d.trim(e[a]);var g="ui-resizable-"+f;var h=d("\x3cdiv class\x3d'ui-resizable-handle "+g+"'\x3e\x3c/div\x3e");h.css({zIndex:c.zIndex});"se"===f&&h.addClass("ui-icon ui-icon-gripsmall-diagonal-se");this.handles[f]=".ui-resizable-"+f;this.element.append(h)}}this._renderAxis=function(a){var c,e,f,g;a=a||this.element;for(c in this.handles)this.handles[c].constructor===String?this.handles[c]=this.element.children(this.handles[c]).first().show():(this.handles[c].jquery||
this.handles[c].nodeType)&&(this.handles[c]=d(this.handles[c]),this._on(this.handles[c],{mousedown:b._mouseDown})),this.elementIsWrapper&&this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i)&&(e=d(this.handles[c],this.element),g=/sw|ne|nw|se|n|s/.test(c)?e.outerHeight():e.outerWidth(),f=["padding",/ne|nw|n/.test(c)?"Top":/se|sw|s/.test(c)?"Bottom":/^e$/.test(c)?"Right":"Left"].join(""),a.css(f,g),this._proportionallyResize()),this._handles=this._handles.add(this.handles[c])};
...
this._on(this.uiDialogTitlebar,{mousedown:function(a){d(a.target).closest(".ui-dialog-titlebar-close")||this.uiDialog.focus()}});this.uiDialogTitlebarClose=d("\x3cbutton type\x3d'button'\x3e\x3c/button\x3e").button({label:this.options.closeText,icons:{primary:"ui-icon-closethick"},text:!1}).addClass("ui-dialog-titlebar-close").appendTo(this.uiDialogTitlebar);this._on(this.uiDialogTitlebarClose,{click:function(a){a.preventDefault();this.close(a)}});var a=d("\x3cspan\x3e").uniqueId().addClass("ui-dialog-title").prependTo(this.uiDialogTitlebar);
...
this.uiButtonSet.empty(),d.isEmptyObject(b)||d.isArray(b)&&!b.length?(this.uiDialog.removeClass("ui-dialog-buttons"),void 0):(d.each(b,function(b,e){e=d.isFunction(e)?{click:e,text:b}:e;e=d.extend({type:"button"},e);var c=e.click;e.click=function(){c.apply(a.element[0],arguments)};b={icons:e.icons,text:e.showText};delete e.icons;delete e.showText;d("\x3cbutton\x3e\x3c/button\x3e",e).button(b).appendTo(a.uiButtonSet)}),this.uiDialog.addClass("ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog),
void 0)},_makeDraggable:function(){function a(a){return{position:a.position,offset:a.offset}}var b=this,c=this.options;this.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(c,f){d(this).addClass("ui-dialog-dragging");b._blockFrames();b._trigger("dragStart",c,a(f))},drag:function(c,d){b._trigger("drag",c,a(d))},stop:function(e,f){var g=f.offset.left-b.document.scrollLeft(),h=f.offset.top-b.document.scrollTop();
...
g?"isover":"isout"]=!1,this["isover"===g?"_over":"_out"].call(this,b),c&&"isout"===g&&(c.isout=!1,c.isover=!0,c._over.call(c,b)))}})},dragStop:function(a,b){a.element.parentsUntil("body").unbind("scroll.droppable");a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,b)}};d.ui.droppable;d.effects={effect:{}};(function(a,b){function c(a,b,c){var d=m[b.type]||{};return null==a?c||!b.def?null:b.def:(a=d.floor?~~a:parseFloat(a),isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:0>a?0:a>d.max?d.max:a)}function d(c){var d=
k(),e=d._rgba=[];return c=c.toLowerCase(),q(h,function(a,f){var g;a=(a=f.re.exec(c))&&f.parse(a);f=f.space||"rgba";return a?(g=d[f](a),d[l[f].cache]=g[l[f].cache],e=d._rgba=g._rgba,!1):b}),e.length?("0,0,0,0"===e.join()&&a.extend(e,t.transparent),d):t[c]}function f(a,b,c){return c=(c+1)%1,1>6*c?a+6*(b-a)*c:1>2*c?b:2>3*c?a+6*(b-a)*(2/3-c):a}var g=/^([\-+])=\s*(\d+\.?\d*)/,h=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],a[2],
...
n.rgba=-1<p.style.backgroundColor.indexOf("rgba");q(l,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(e,f,g,h){if(e===b)return this._rgba=[null,null,null,null],this;(e.jquery||e.nodeType)&&(e=a(e).css(f),f=b);var m=this,n=a.type(e),r=this._rgba=[];return f!==b&&(e=[e,f,g,h],n="array"),"string"===n?this.parse(d(e)||t._default):"array"===n?(q(l.rgba.props,function(a,b){r[b.idx]=c(e[b.idx],b)}),this):"object"===n?(e instanceof k?q(l,
function(a,b){e[b.cache]&&(m[b.cache]=e[b.cache].slice())}):q(l,function(b,d){var f=d.cache;q(d.props,function(a,b){if(!m[f]&&d.to){if("alpha"===a||null==e[a])return;m[f]=d.to(m._rgba)}m[f][b.idx]=c(e[a],b,!0)});m[f]&&0>a.inArray(null,m[f].slice(0,3))&&(m[f][3]=1,d.from&&(m._rgba=d.from(m[f])))}),this):b},is:function(a){var c=k(a),d=!0,e=this;return q(l,function(a,f){var g,h=c[f.cache];return h&&(g=e[f.cache]||f.to&&f.to(e._rgba)||[],q(f.props,function(a,c){return null!=h[c.idx]?d=h[c.idx]===g[c.idx]:
b})),d}),d},_space:function(){var a=[],b=this;return q(l,function(c,d){b[d.cache]&&a.push(c)}),a.pop()},transition:function(a,b){var d=k(a);a=d._space();var e=l[a],f=0===this.alpha()?k("transparent"):this,g=f[e.cache]||e.to(f._rgba),h=g.slice();return d=d[e.cache],q(e.props,function(a,e){a=e.idx;var f=g[a],k=d[a],l=m[e.type]||{};null!==k&&(null===f?h[a]=k:(l.mod&&(k-f>l.mod/2?f+=l.mod:f-k>l.mod/2&&(f-=l.mod)),h[a]=c((k-f)*b+f,e)))}),this[a](h)},blend:function(b){if(1===this._rgba[3])return this;var c=
...
c.push(~~(255*d)),"#"+a.map(c,function(a){return a=(a||0).toString(16),1===a.length?"0"+a:a}).join("")},toString:function(){return 0===this._rgba[3]?"transparent":this.toRgbaString()}});k.fn.parse.prototype=k.fn;l.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b,c,d=a[0]/255,e=a[1]/255,f=a[2]/255;a=a[3];var g=Math.max(d,e,f),h=Math.min(d,e,f),k=g-h,l=g+h,m=.5*l;return b=h===g?0:d===g?60*(e-f)/k+360:e===g?60*(f-d)/k+120:60*(d-e)/k+240,c=0===k?0:.5>=m?k/l:
k/(2-l),[Math.round(b)%360,c,m,null==a?1:a]};l.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*f(d,c,b+1/3)),Math.round(255*f(d,c,b)),Math.round(255*f(d,c,b-1/3)),a]};q(l,function(d,e){var f=e.props,h=e.cache,l=e.to,m=e.from;k.fn[d]=function(d){if(l&&!this[h]&&(this[h]=l(this._rgba)),d===b)return this[h].slice();var e,g=a.type(d),n="array"===g||"object"===g?d:arguments,
p=this[h].slice();return q(f,function(a,b){a=n["object"===g?a:b.idx];null==a&&(a=p[b.idx]);p[b.idx]=c(a,b)}),m?(e=k(m(p)),e[h]=p,e):k(p)};q(f,function(b,c){k.fn[b]||(k.fn[b]=function(e){var f,h=a.type(e),k="alpha"===b?this._hsla?"hsla":"rgba":d,l=this[k](),m=l[c.idx];return"undefined"===h?m:("function"===h&&(e=e.call(this,m),h=a.type(e)),null==e&&c.empty?this:("string"===h&&(f=g.exec(e),f&&(e=m+parseFloat(f[2])*("+"===f[1]?1:-1))),l[c.idx]=e,this[k](l)))})})});k.hook=function(b){b=b.split(" ");q(b,
function(b,c){a.cssHooks[c]={set:function(b,e){var f,g="";if("transparent"!==e&&("string"!==a.type(e)||(f=d(e)))){if(e=k(f||e),!n.rgba&&1!==e._rgba[3]){for(f="backgroundColor"===c?b.parentNode:b;(""===g||"transparent"===g)&&f&&f.style;)try{g=a.css(f,"backgroundColor"),f=f.parentNode}catch(B){}e=e.blend(g&&"transparent"!==g?g:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(B){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,
b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");a.cssHooks.borderColor={expand:function(a){var b={};return q(["Top","Right","Bottom","Left"],function(c,d){b["border"+d+"Color"]=a}),b}};var t=a.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",
...
b||d.contains(a[0],b))&&d(b).focus()),a},setTransition:function(a,b,f,g){return g=g||{},d.each(b,function(b,c){b=a.cssUnit(c);0<b[0]&&(g[c]=b[0]*f+b[1])}),g}});d.fn.extend({effect:function(){function b(a){function b(){d.isFunction(f)&&f.call(c[0]);d.isFunction(a)&&a()}var c=d(this),f=e.complete,g=e.mode;(c.is(":hidden")?"hide"===g:"show"===g)?(c[g](),b()):h.call(c[0],e,b)}var e=a.apply(this,arguments),f=e.mode,g=e.queue,h=d.effects.effect[e.effect];return d.fx.off||!h?f?this[f](e.duration,e.complete):
this.each(function(){e.complete&&e.complete.call(this)}):!1===g?this.each(b):this.queue(g||"fx",b)},show:function(c){return function(d){if(b(d))return c.apply(this,arguments);var e=a.apply(this,arguments);return e.mode="show",this.effect.call(this,e)}}(d.fn.show),hide:function(c){return function(d){if(b(d))return c.apply(this,arguments);var e=a.apply(this,arguments);return e.mode="hide",this.effect.call(this,e)}}(d.fn.hide),toggle:function(c){return function(d){if(b(d)||"boolean"==typeof d)return c.apply(this,
arguments);var e=a.apply(this,arguments);return e.mode="toggle",this.effect.call(this,e)}}(d.fn.toggle),cssUnit:function(a){var b=this.css(a),c=[];return d.each(["em","px","%","pt"],function(a,d){0<b.indexOf(d)&&(c=[parseFloat(b),d])}),c}})})();(function(){var a={};d.each(["Quad","Cubic","Quart","Quint","Expo"],function(b,c){a[c]=function(a){return Math.pow(a,b+2)}});d.extend(a,{Sine:function(a){return 1-Math.cos(a*Math.PI/2)},Circ:function(a){return 1-Math.sqrt(1-a*a)},Elastic:function(a){return 0===
a||1===a?a:-Math.pow(2,8*(a-1))*Math.sin((80*(a-1)-7.5)*Math.PI/15)},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var b,d=4;((b=Math.pow(2,--d))-1)/11>a;);return 1/Math.pow(4,3-d)-7.5625*Math.pow((3*b-2)/22-a,2)}});d.each(a,function(a,c){d.easing["easeIn"+a]=c;d.easing["easeOut"+a]=function(a){return 1-c(1-a)};d.easing["easeInOut"+a]=function(a){return.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects;d.effects.effect.blind=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),
f=d.effects.setMode(c,a.mode||"hide");var g=a.direction||"up";var h=/up|down|vertical/.test(g),k=h?"height":"width",l=h?"top":"left",m=/up|left|vertical|horizontal/.test(g),n={},p="show"===f;c.parent().is(".ui-effects-wrapper")?d.effects.save(c.parent(),e):d.effects.save(c,e);c.show();g=d.effects.createWrapper(c).css({overflow:"hidden"});var q=g[k]();var t=parseFloat(g.css(l))||0;n[k]=p?q:0;m||(c.css(h?"bottom":"right",0).css(h?"top":"left","auto").css({position:"absolute"}),n[l]=p?t:q+t);p&&(g.css(k,
0),m||g.css(l,t+q));g.animate(n,{duration:a.duration,easing:a.easing,queue:!1,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.bounce=function(a,b){var c,e=d(this),f="position top bottom left right height width".split(" "),g=d.effects.setMode(e,a.mode||"effect"),h="hide"===g;var k="show"===g;var l=a.direction||"up";g=a.distance;var m=a.times||5,n=2*m+(k||h?1:0),p=a.duration/n;a=a.easing;var q="up"===l||"down"===l?"top":"left";l="up"===
l||"left"===l;var t=e.queue(),r=t.length;(k||h)&&f.push("opacity");d.effects.save(e,f);e.show();d.effects.createWrapper(e);g||(g=e["top"===q?"outerHeight":"outerWidth"]()/3);k&&(c={opacity:1},c[q]=0,e.css("opacity",0).css(q,l?2*-g:2*g).animate(c,p,a));h&&(g/=Math.pow(2,m-1));c={};for(k=c[q]=0;m>k;k++){var u={};u[q]=(l?"-\x3d":"+\x3d")+g;e.animate(u,p,a).animate(c,p,a);g=h?2*g:g/2}h&&(u={opacity:0},u[q]=(l?"-\x3d":"+\x3d")+g,e.animate(u,p,a));e.queue(function(){h&&e.hide();d.effects.restore(e,f);d.effects.removeWrapper(e);
b()});1<r&&t.splice.apply(t,[1,0].concat(t.splice(r,n+1)));e.dequeue()};d.effects.effect.clip=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f="show"===d.effects.setMode(c,a.mode||"hide"),g="vertical"===(a.direction||"vertical"),h=g?"height":"width";g=g?"top":"left";var k={};d.effects.save(c,e);c.show();var l=d.effects.createWrapper(c).css({overflow:"hidden"});l="IMG"===c[0].tagName?l:c;var m=l[h]();f&&(l.css(h,0),l.css(g,m/2));k[h]=f?m:0;k[g]=f?0:m/2;l.animate(k,
{queue:!1,duration:a.duration,easing:a.easing,complete:function(){f||c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.drop=function(a,b){var c=d(this),e="position top bottom left right opacity height width".split(" "),f=d.effects.setMode(c,a.mode||"hide"),g="show"===f;var h=a.direction||"left";var k="up"===h||"down"===h?"top":"left",l="up"===h||"left"===h?"pos":"neg",m={opacity:g?1:0};d.effects.save(c,e);c.show();d.effects.createWrapper(c);h=a.distance||c["top"===
k?"outerHeight":"outerWidth"](!0)/2;g&&c.css("opacity",0).css(k,"pos"===l?-h:h);m[k]=(g?"pos"===l?"+\x3d":"-\x3d":"pos"===l?"-\x3d":"+\x3d")+h;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.explode=function(a,b){function c(){q.push(this);q.length===g*h&&(k.css({visibility:"visible"}),d(q).remove(),l||k.hide(),b())}var e,f,g=a.pieces?Math.round(Math.sqrt(a.pieces)):3,h=g,k=
d(this),l="show"===d.effects.setMode(k,a.mode||"hide"),m=k.show().css("visibility","hidden").offset(),n=Math.ceil(k.outerWidth()/h),p=Math.ceil(k.outerHeight()/g),q=[];for(e=0;g>e;e++){var t=m.top+e*p;var r=e-(g-1)/2;for(f=0;h>f;f++){var u=m.left+f*n;var x=f-(h-1)/2;k.clone().appendTo("body").wrap("\x3cdiv\x3e\x3c/div\x3e").css({position:"absolute",visibility:"visible",left:-f*n,top:-e*p}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:n,height:p,left:u+(l?
x*n:0),top:t+(l?r*p:0),opacity:l?0:1}).animate({left:u+(l?0:x*n),top:t+(l?0:r*p),opacity:l?1:0},a.duration||500,a.easing,c)}}};d.effects.effect.fade=function(a,b){var c=d(this),e=d.effects.setMode(c,a.mode||"toggle");c.animate({opacity:e},{queue:!1,duration:a.duration,easing:a.easing,complete:b})};d.effects.effect.fold=function(a,b){var c,e=d(this),f="position top bottom left right height width".split(" ");var g=d.effects.setMode(e,a.mode||"hide");var h="show"===g,k="hide"===g,l=a.size||15,m=/([0-9]+)%/.exec(l),
n=!!a.horizFirst,p=(c=h!==n)?["width","height"]:["height","width"],q=a.duration/2,t={},r={};d.effects.save(e,f);e.show();g=d.effects.createWrapper(e).css({overflow:"hidden"});c=c?[g.width(),g.height()]:[g.height(),g.width()];m&&(l=parseInt(m[1],10)/100*c[k?0:1]);h&&g.css(n?{height:0,width:l}:{height:l,width:0});t[p[0]]=h?c[0]:l;r[p[1]]=h?c[1]:0;g.animate(t,q,a.easing).animate(r,q,a.easing,function(){k&&e.hide();d.effects.restore(e,f);d.effects.removeWrapper(e);b()})};d.effects.effect.highlight=function(a,
...
var g="position top bottom left right overflow opacity".split(" ");var h=["width","height","overflow"],k=["fontSize"],l=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],m=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"],n=d.effects.setMode(e,a.mode||"effect"),p=a.restore||"effect"!==n,q=a.scale||"both",t=a.origin||["middle","center"],r=e.css("position"),u=p?f:g,x={height:0,width:0,outerHeight:0,outerWidth:0};"show"===n&&e.show();g={height:e.height(),width:e.width(),
outerHeight:e.outerHeight(),outerWidth:e.outerWidth()};"toggle"===a.mode&&"show"===n?(e.from=a.to||x,e.to=a.from||g):(e.from=a.from||("show"===n?x:g),e.to=a.to||("hide"===n?x:g));var y=e.from.height/g.height;var z=e.from.width/g.width;var v=e.to.height/g.height;var w=e.to.width/g.width;("box"===q||"both"===q)&&(y!==v&&(u=u.concat(l),e.from=d.effects.setTransition(e,l,y,e.from),e.to=d.effects.setTransition(e,l,v,e.to)),z!==w&&(u=u.concat(m),e.from=d.effects.setTransition(e,m,z,e.from),e.to=d.effects.setTransition(e,
m,w,e.to)));("content"===q||"both"===q)&&y!==v&&(u=u.concat(k).concat(h),e.from=d.effects.setTransition(e,k,y,e.from),e.to=d.effects.setTransition(e,k,v,e.to));d.effects.save(e,u);e.show();d.effects.createWrapper(e);e.css("overflow","hidden").css(e.from);t&&(c=d.effects.getBaseline(t,g),e.from.top=(g.outerHeight-e.outerHeight())*c.y,e.from.left=(g.outerWidth-e.outerWidth())*c.x,e.to.top=(g.outerHeight-e.to.outerHeight)*c.y,e.to.left=(g.outerWidth-e.to.outerWidth)*c.x);e.css(e.from);"content"!==q&&
"both"!==q||(l=l.concat(["marginTop","marginBottom"]).concat(k),m=m.concat(["marginLeft","marginRight"]),h=f.concat(l).concat(m),e.find("*[width]").each(function(){var b=d(this),c=b.height(),e=b.width(),f=b.outerHeight(),g=b.outerWidth();p&&d.effects.save(b,h);b.from={height:c*y,width:e*z,outerHeight:f*y,outerWidth:g*z};b.to={height:c*v,width:e*w,outerHeight:c*v,outerWidth:e*w};y!==v&&(b.from=d.effects.setTransition(b,l,y,b.from),b.to=d.effects.setTransition(b,l,v,b.to));z!==w&&(b.from=d.effects.setTransition(b,
m,z,b.from),b.to=d.effects.setTransition(b,m,w,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){p&&d.effects.restore(b,h)})}));e.animate(e.to,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){0===e.to.opacity&&e.css("opacity",e.from.opacity);"hide"===n&&e.hide();d.effects.restore(e,u);p||("static"===r?e.css({position:"relative",top:e.to.top,left:e.to.left}):d.each(["top","left"],function(a,b){e.css(b,function(b,c){b=parseInt(c,10);var d=a?e.to.left:e.to.top;return"auto"===
c?d+"px":b+d+"px"})}));d.effects.removeWrapper(e);b()}})};d.effects.effect.scale=function(a,b){var c=d(this),e=d.extend(!0,{},a),f=d.effects.setMode(c,a.mode||"effect"),g=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"hide"===f?0:100),h=a.direction||"both",k=a.origin,l={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()},m="horizontal"!==h?g/100:1;g="vertical"!==h?g/100:1;e.effect="size";e.queue=!1;e.complete=b;"effect"!==f&&(e.origin=k||["middle","center"],
e.restore=!0);e.from=a.from||("show"===f?{height:0,width:0,outerHeight:0,outerWidth:0}:l);e.to={height:l.height*m,width:l.width*g,outerHeight:l.outerHeight*m,outerWidth:l.outerWidth*g};e.fade&&("show"===f&&(e.from.opacity=0,e.to.opacity=1),"hide"===f&&(e.from.opacity=1,e.to.opacity=0));c.effect(e)};d.effects.effect.puff=function(a,b){var c=d(this),e=d.effects.setMode(c,a.mode||"hide"),f="hide"===e,g=parseInt(a.percent,10)||150,h=g/100,k={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),
outerWidth:c.outerWidth()};d.extend(a,{effect:"scale",queue:!1,fade:!0,mode:e,complete:b,percent:f?g:100,from:f?k:{height:k.height*h,width:k.width*h,outerHeight:k.outerHeight*h,outerWidth:k.outerWidth*h}});c.effect(a)};d.effects.effect.pulsate=function(a,b){var c=d(this),e=d.effects.setMode(c,a.mode||"show");var f="show"===e;var g="hide"===e;e=2*(a.times||5)+(f||"hide"===e?1:0);var h=a.duration/e,k=0,l=c.queue(),m=l.length;(f||!c.is(":visible"))&&(c.css("opacity",0).show(),k=1);for(f=1;e>f;f++)c.animate({opacity:k},
h,a.easing),k=1-k;c.animate({opacity:k},h,a.easing);c.queue(function(){g&&c.hide();b()});1<m&&l.splice.apply(l,[1,0].concat(l.splice(m,e+1)));c.dequeue()};d.effects.effect.shake=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f=d.effects.setMode(c,a.mode||"effect"),g=a.direction||"left";var h=a.distance||20;var k=a.times||3,l=2*k+1,m=Math.round(a.duration/l),n="up"===g||"down"===g?"top":"left",p="up"===g||"left"===g;g={};var q={},t={},r=c.queue(),u=r.length;
d.effects.save(c,e);c.show();d.effects.createWrapper(c);g[n]=(p?"-\x3d":"+\x3d")+h;q[n]=(p?"+\x3d":"-\x3d")+2*h;t[n]=(p?"-\x3d":"+\x3d")+2*h;c.animate(g,m,a.easing);for(h=1;k>h;h++)c.animate(q,m,a.easing).animate(t,m,a.easing);c.animate(q,m,a.easing).animate(g,m/2,a.easing).queue(function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()});1<u&&r.splice.apply(r,[1,0].concat(r.splice(u,l+1)));c.dequeue()};d.effects.effect.slide=function(a,b){var c=d(this),e="position top bottom left right width height".split(" "),
f=d.effects.setMode(c,a.mode||"show"),g="show"===f;var h=a.direction||"left";var k="up"===h||"down"===h?"top":"left",l="up"===h||"left"===h,m={};d.effects.save(c,e);c.show();h=a.distance||c["top"===k?"outerHeight":"outerWidth"](!0);d.effects.createWrapper(c).css({overflow:"hidden"});g&&c.css(k,l?isNaN(h)?"-"+h:-h:h);m[k]=(g?l?"+\x3d":"-\x3d":l?"-\x3d":"+\x3d")+h;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);
b()}})};d.effects.effect.transfer=function(a,b){var c=d(this),e=d(a.to),f="fixed"===e.css("position"),g=d("body"),h=f?g.scrollTop():0;g=f?g.scrollLeft():0;var k=e.offset();e={top:k.top-h,left:k.left-g,height:e.innerHeight(),width:e.innerWidth()};k=c.offset();var l=d("\x3cdiv class\x3d'ui-effects-transfer'\x3e\x3c/div\x3e").appendTo(document.body).addClass(a.className).css({top:k.top-h,left:k.left-g,height:c.innerHeight(),width:c.innerWidth(),position:f?"fixed":"absolute"}).animate(e,a.duration,a.easing,
function(){l.remove();b()})};d.widget("ui.progressbar",{version:"1.11.4",options:{max:100,value:0,change:null,complete:null},min:0,_create:function(){this.oldValue=this.options.value=this._constrainedValue();this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min});this.valueDiv=d("\x3cdiv class\x3d'ui-progressbar-value ui-widget-header ui-corner-left'\x3e\x3c/div\x3e").appendTo(this.element);this._refreshValue()},_destroy:function(){this.element.removeClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");
...
!1,this._toggleAttr(),this.range=null,this._off(this.document),this._trigger("close",a))},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderMenu:function(a,b){var c=this,e="";d.each(b,function(b,g){g.optgroup!==e&&(d("\x3cli\x3e",{"class":"ui-selectmenu-optgroup ui-menu-divider"+(g.element.parent("optgroup").prop("disabled")?" ui-state-disabled":""),text:g.optgroup}).appendTo(a),e=g.optgroup);c._renderItemData(a,g)})},_renderItemData:function(a,b){return this._renderItem(a,
...
b=b.slice(0,e));for(a=b.length;e>a;a++)c.push("\x3cspan class\x3d'ui-slider-handle ui-state-default ui-corner-all' tabindex\x3d'0'\x3e\x3c/span\x3e");this.handles=b.add(d(c.join("")).appendTo(this.element));this.handle=this.handles.eq(0);this.handles.each(function(a){d(this).data("ui-slider-handle-index",a)})},_createRange:function(){var a=this.options,b="";a.range?(!0===a.range&&(a.values?a.values.length&&2!==a.values.length?a.values=[a.values[0],a.values[0]]:d.isArray(a.values)&&(a.values=a.values.slice(0)):
...
this._hoverable(this.handles);this._focusable(this.handles)},_destroy:function(){this.handles.remove();this.range&&this.range.remove();this.element.removeClass("ui-slider ui-slider-horizontal ui-slider-vertical ui-widget ui-widget-content ui-corner-all");this._mouseDestroy()},_mouseCapture:function(a){var b,c,e,f,g,h,k,l,m=this,n=this.options;return n.disabled?!1:(this.elementSize={width:this.element.outerWidth(),height:this.element.outerHeight()},this.elementOffset=this.element.offset(),b={x:a.pageX,
y:a.pageY},c=this._normValueFromMouse(b),e=this._valueMax()-this._valueMin()+1,this.handles.each(function(a){var b=Math.abs(c-m.values(a));(e>b||e===b&&(a===m._lastChangedValue||m.values(a)===n.min))&&(e=b,f=d(this),g=a)}),h=this._start(a,g),!1===h?!1:(this._mouseSliding=!0,this._handleIndex=g,f.addClass("ui-state-active").focus(),k=f.offset(),l=!d(a.target).parents().addBack().is(".ui-slider-handle"),this._clickOffset=l?{left:0,top:0}:{left:a.pageX-k.left-f.width()/2,top:a.pageY-k.top-f.height()/
2-(parseInt(f.css("borderTopWidth"),10)||0)-(parseInt(f.css("borderBottomWidth"),10)||0)+(parseInt(f.css("marginTop"),10)||0)},this.handles.hasClass("ui-state-hover")||this._slide(a,g,c),this._animateOff=!0,!0))},_mouseStart:function(){return!0},_mouseDrag:function(a){var b=this._normValueFromMouse({x:a.pageX,y:a.pageY});return this._slide(a,this._handleIndex,b),!1},_mouseStop:function(a){return this.handles.removeClass("ui-state-active"),this._mouseSliding=!1,this._stop(a,this._handleIndex),this._change(a,
...
0>d&&(d=0),"vertical"===this.orientation&&(d=1-d),f=this._valueMax()-this._valueMin(),g=this._valueMin()+d*f,this._trimAlignValue(g)},_start:function(a,b){var c={handle:this.handles[b],value:this.value()};return this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values()),this._trigger("start",a,c)},_slide:function(a,b,c){var d,f,g;this.options.values&&this.options.values.length?(d=this.values(b?0:1),2===this.options.values.length&&!0===this.options.range&&(0===
b&&c>d||1===b&&d>c)&&(c=d),c!==this.values(b)&&(f=this.values(),f[b]=c,g=this._trigger("slide",a,{handle:this.handles[b],value:c,values:f}),this.values(b?0:1),!1!==g&&this.values(b,c))):c!==this.value()&&(g=this._trigger("slide",a,{handle:this.handles[b],value:c}),!1!==g&&this.value(c))},_stop:function(a,b){var c={handle:this.handles[b],value:this.value()};this.options.values&&this.options.values.length&&(c.value=this.values(b),c.values=this.values());this._trigger("stop",a,c)},_change:function(a,
...
this._refreshValue(),this._change(null,a),void 0;if(!arguments.length)return this._values();if(!d.isArray(arguments[0]))return this.options.values&&this.options.values.length?this._values(a):this.value();var e=this.options.values;var f=arguments[0];for(c=0;e.length>c;c+=1)e[c]=this._trimAlignValue(f[c]),this._change(null,c);this._refreshValue()},_setOption:function(a,b){var c=0;switch("range"===a&&!0===this.options.range&&("min"===b?(this.options.value=this._values(0),this.options.values=null):"max"===
...
"%"},{queue:!1,duration:h.animate})):(0===c&&k.range.stop(1,1)[l?"animate":"css"]({bottom:b+"%"},h.animate),1===c&&k.range[l?"animate":"css"]({height:b-a+"%"},{queue:!1,duration:h.animate})));a=b}):(c=this.value(),e=this._valueMin(),f=this._valueMax(),b=f!==e?(c-e)/(f-e)*100:0,m["horizontal"===this.orientation?"left":"bottom"]=b+"%",this.handle.stop(1,1)[l?"animate":"css"](m,h.animate),"min"===g&&"horizontal"===this.orientation&&this.range.stop(1,1)[l?"animate":"css"]({width:b+"%"},h.animate),"max"===
g&&"horizontal"===this.orientation&&this.range[l?"animate":"css"]({width:100-b+"%"},{queue:!1,duration:h.animate}),"min"===g&&"vertical"===this.orientation&&this.range.stop(1,1)[l?"animate":"css"]({height:b+"%"},h.animate),"max"===g&&"vertical"===this.orientation&&this.range[l?"animate":"css"]({height:100-b+"%"},{queue:!1,duration:h.animate}))},_handleEvents:{keydown:function(a){var b,c,e,f=d(a.target).data("ui-slider-handle-index");switch(a.keyCode){case d.ui.keyCode.HOME:case d.ui.keyCode.END:case d.ui.keyCode.PAGE_UP:case d.ui.keyCode.PAGE_DOWN:case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(a.preventDefault(),
...
this.document[0].body?0:this.offsetParent[0].scrollLeft));e&&"y"!==e||(f.top=b.top-this.offset.parent.top-this.margins.top+(this.offsetParent[0]===this.document[0].body?0:this.offsetParent[0].scrollTop));this.reverting=!0;d(this.helper).animate(f,parseInt(this.options.revert,10)||500,function(){c._clear(a)})}else this._clear(a,b);return!1}},cancel:function(){if(this.dragging){this._mouseUp({target:null});"original"===this.options.helper?this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper"):
...
toArray:function(a){var b=this._getItemsAsjQuery(a&&a.connected),c=[];return a=a||{},b.each(function(){c.push(d(a.item||this).attr(a.attribute||"id")||"")}),c},_intersectsWith:function(a){var b=this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,f=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,l=k+a.height,m=this.offset.click.top,n=this.offset.click.left;m="x"===this.options.axis||d+m>k&&l>d+m;n="y"===this.options.axis||b+n>g&&h>b+n;return"pointer"===this.options.tolerance||
this.options.forcePointerForContainers||"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?m&&n:b+this.helperProportions.width/2>g&&h>c-this.helperProportions.width/2&&d+this.helperProportions.height/2>k&&l>f-this.helperProportions.height/2},_intersectsWithPointer:function(a){var b="x"===this.options.axis||this._isOverAxis(this.positionAbs.top+this.offset.click.top,a.top,a.height);a="y"===this.options.axis||this._isOverAxis(this.positionAbs.left+
...
h=[[d.isFunction(this.options.items)?this.options.items.call(this.element[0],a,{item:this.currentItem}):d(this.options.items,this.element),this]];if((f=this._connectWith())&&this.ready)for(b=f.length-1;0<=b;b--){var k=d(f[b],this.document[0]);for(c=k.length-1;0<=c;c--)(e=d.data(k[c],this.widgetFullName))&&e!==this&&!e.options.disabled&&(h.push([d.isFunction(e.options.items)?e.options.items.call(e.element[0],a,{item:this.currentItem}):d(e.options.items,e.element),e]),this.containers.push(e))}for(b=
...
this.currentItem[0]||(c=this.options.toleranceElement?d(this.options.toleranceElement,f.item):f.item,a||(f.width=c.outerWidth(),f.height=c.outerHeight()),e=c.offset(),f.left=e.left,f.top=e.top)}if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(b=this.containers.length-1;0<=b;b--)e=this.containers[b].element.offset(),this.containers[b].containerCache.left=e.left,this.containers[b].containerCache.top=e.top,this.containers[b].containerCache.width=
this.containers[b].element.outerWidth(),this.containers[b].containerCache.height=this.containers[b].element.outerHeight();return this},_createPlaceholder:function(a){a=a||this;var b,c=a.options;c.placeholder&&c.placeholder.constructor!==String||(b=c.placeholder,c.placeholder={element:function(){var c=a.currentItem[0].nodeName.toLowerCase(),f=d("\x3c"+c+"\x3e",a.document[0]).addClass(b||a.currentItem[0].className+" ui-sortable-placeholder").removeClass("ui-sortable-helper");return"tbody"===c?a._createTrPlaceholder(a.currentItem.find("tr").eq(0),
...
e&&d.contains(this.containers[b].element[0],e.element[0])||(e=this.containers[b],h=b):this.containers[b].containerCache.over&&(this.containers[b]._trigger("out",a,this._uiHash(this)),this.containers[b].containerCache.over=0));if(e)if(1===this.containers.length)this.containers[h].containerCache.over||(this.containers[h]._trigger("over",a,this._uiHash(this)),this.containers[h].containerCache.over=1);else{b=1E4;var k=null;e=(c=e.floating||this._isFloating(this.currentItem))?"left":"top";var l=c?"width":
"height";var m=c?"clientX":"clientY";for(c=this.items.length-1;0<=c;c--)d.contains(this.containers[h].element[0],this.items[c].item[0])&&this.items[c].item[0]!==this.currentItem[0]&&(f=this.items[c].item.offset()[e],g=!1,a[m]-f>this.items[c][l]/2&&(g=!0),b>Math.abs(a[m]-f)&&(b=Math.abs(a[m]-f),k=this.items[c],this.direction=g?"up":"down"));if(k||this.options.dropOnEmpty){if(this.currentContainer===this.containers[h])return this.currentContainer.containerCache.over||(this.containers[h]._trigger("over",
...
this.buttons.last().find(".ui-icon").removeClass(this.options.icons.down).addClass(b.down));this._super(a,b);"disabled"===a&&(this.widget().toggleClass("ui-state-disabled",!!b),this.element.prop("disabled",!!b),this.buttons.button(b?"disable":"enable"))},_setOptions:F(function(a){this._super(a)}),_parse:function(a){return"string"==typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(a,10,this.options.culture):+a),""===a||isNaN(a)?null:a},_format:function(a){return""===
...
_destroy:function(){this.element.removeClass("ui-spinner-input").prop("disabled",!1).removeAttr("autocomplete").removeAttr("role").removeAttr("aria-valuemin").removeAttr("aria-valuemax").removeAttr("aria-valuenow");this.uiSpinner.replaceWith(this.element)},stepUp:F(function(a){this._stepUp(a)}),_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:F(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),
this._stop())},pageUp:F(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:F(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){return arguments.length?(F(this._value).call(this,a),void 0):this._parse(this.element.val())},widget:function(){return this.uiSpinner}});d.widget("ui.tabs",{version:"1.11.4",delay:300,options:{active:null,collapsible:!1,event:"click",heightStyle:"content",hide:null,show:null,activate:null,beforeActivate:null,beforeLoad:null,load:null},_isLocal:function(){var a=
...
"focus"+this.eventNamespace,function(){d(this).closest("li").is(".ui-state-disabled")&&this.blur()});this.tabs=this.tablist.find("\x3e li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({role:"tab",tabIndex:-1});this.anchors=this.tabs.map(function(){return d("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1});this.panels=d();this.anchors.each(function(b,c){var e,f,g,m=d(c).uniqueId().attr("id"),n=d(c).closest("li"),p=n.attr("aria-controls");a._isLocal(c)?
(e=c.hash,g=e.substring(1),f=a.element.find(a._sanitizeSelector(e))):(g=n.attr("aria-controls")||d({}).uniqueId()[0].id,e="#"+g,f=a.element.find(e),f.length||(f=a._createPanel(g),f.insertAfter(a.panels[b-1]||a.tablist)),f.attr("aria-live","polite"));f.length&&(a.panels=a.panels.add(f));p&&n.data("ui-tabs-aria-controls",p);n.attr({"aria-controls":g,"aria-labelledby":m});f.attr("aria-labelledby",m)});this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").attr("role","tabpanel");b&&
(this._off(b.not(this.tabs)),this._off(c.not(this.anchors)),this._off(e.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol,ul").eq(0)},_createPanel:function(a){return d("\x3cdiv\x3e").attr("id",a).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",!0)},_setupDisabled:function(a){d.isArray(a)&&(a.length?a.length===this.anchors.length&&(a=!0):a=!1);for(var b,c=0;b=this.tabs[c];c++)!0===a||-1!==d.inArray(c,a)?d(b).addClass("ui-state-disabled").attr("aria-disabled",
...
this.options.disabled;if(!0!==b){if(void 0===a)b=!0;else{if(a=this._getIndex(a),-1!==d.inArray(a,b))return;b=d.isArray(b)?d.merge([a],b).sort():[a]}this._setupDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,e=this.tabs.eq(a);a=e.find(".ui-tabs-anchor");var f=this._getPanelForTab(e),g={tab:e,panel:f},h=function(a,b){"abort"===b&&c.panels.stop(!1,!0);e.removeClass("ui-tabs-loading");f.removeAttr("aria-busy");a===c.xhr&&delete c.xhr};this._isLocal(a[0])||(this.xhr=d.ajax(this._ajaxSettings(a,
b,g)),this.xhr&&"canceled"!==this.xhr.statusText&&(e.addClass("ui-tabs-loading"),f.attr("aria-busy","true"),this.xhr.done(function(a,d,e){setTimeout(function(){f.html(a);c._trigger("load",b,g);h(e,d)},1)}).fail(function(a,b){setTimeout(function(){h(a,b)},1)})))},_ajaxSettings:function(a,b,c){var e=this;return{url:a.attr("href"),beforeSend:function(a,g){return e._trigger("beforeLoad",b,d.extend({jqXHR:a,ajaxSettings:g},c))}}},_getPanelForTab:function(a){a=d(a).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+
...
a.currentTarget=this,b.close(a,!0));c.attr("title")&&(c.uniqueId(),b.parents[this.id]={element:this,title:c.attr("title")},c.attr("title",""))}),this._registerCloseHandlers(a,c),this._updateContent(c,a))},_updateContent:function(a,b){var c,d=this.options.content,f=this,g=b?b.type:null;return"string"==typeof d?this._open(b,a,d):(c=d.call(a[0],function(c){f._delay(function(){a.data("ui-tooltip-open")&&(b&&(b.type=g),this._open(b,a,c))})}),c&&this._open(b,a,c),void 0)},_open:function(a,b,c){function e(a){k.of=
a;l.is(":hidden")||l.position(k)}var f,g,h,k=d.extend({},this.options.position);if(c){if(f=this._find(b))return f.tooltip.find(".ui-tooltip-content").html(c),void 0;b.is("[title]")&&(a&&"mouseover"===a.type?b.attr("title",""):b.removeAttr("title"));f=this._tooltip(b);var l=f.tooltip;this._addDescribedBy(b,l.attr("id"));l.find(".ui-tooltip-content").html(c);this.liveRegion.children().hide();c.clone?(h=c.clone(),h.removeAttr("id").find("[id]").removeAttr("id")):h=c;d("\x3cdiv\x3e").html(h).appendTo(this.liveRegion);
this.options.track&&a&&/^mouse/.test(a.type)?(this._on(this.document,{mousemove:e}),e(a)):l.position(d.extend({of:b},this.options.position));l.hide();this._show(l,this.options.show);this.options.show&&this.options.show.delay&&(g=this.delayedShow=setInterval(function(){l.is(":visible")&&(e(k.of),clearInterval(g))},d.fx.interval));this._trigger("open",a,{tooltip:l})}},_registerCloseHandlers:function(a,b){var c={keyup:function(a){a.keyCode===d.ui.keyCode.ESCAPE&&(a=d.Event(a),a.currentTarget=b[0],this.close(a,
...
this.options.hide,function(){c._removeTooltip(d(this))}),e.removeData("ui-tooltip-open"),this._off(e,"mouseleave focusout keyup"),e[0]!==this.element[0]&&this._off(e,"remove"),this._off(this.document,"mousemove"),a&&"mouseleave"===a.type&&d.each(this.parents,function(a,b){d(b.element).attr("title",b.title);delete c.parents[a]}),f.closing=!0,this._trigger("close",a,{tooltip:b}),f.hiding||(f.closing=!1)),void 0):(e.removeData("ui-tooltip-open"),void 0)},_tooltip:function(a){var b=d("\x3cdiv\x3e").attr("role",
