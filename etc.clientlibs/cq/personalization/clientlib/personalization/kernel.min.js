...
isNaN(parseFloat(g-0))||(h="parseFloat");try{if(a){f="";var e=CQ.shared.XSS.getXSSTablePropertyValue(a,b);if("function"==typeof d)return d.call(this,e,g,h);if(h)f=h+"('"+e+"') "+d+" "+h+"('"+g+"')";else{var k=c(e),q=c(g);f="'"+k+"' "+d+" '"+q+"'"}return eval(f)}}catch(r){}return!1}}}();
...
b=b.replace(/\r/ig,""),f(a,b),delete CQ_Analytics.Utils.teasersLoading[a],g()}else f(a,"")})},l=$CQ("#"+b).children().length;if(0<l){var n=0;$CQ("#"+b).children().fadeOut(function(){var a=$CQ(this);window.setTimeout(function(){a.remove();n++;n>=l&&g()},50)})}else g()},clearElement:function(a){a&&$CQ("#"+a).html("")},indexOf:function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]==b)return c;return-1},load:function(a,b,c){return CQ.shared.HTTP.get(a,b,c)},post:function(a,b,c,d){return CQ.shared.HTTP.post(a,
...
CQ_Analytics.ClientContextUtils=new function(){return{renderStoreProperty:function(a,b,c,d,e,f){if(CQ_Analytics&&CQ_Analytics.CCM)CQ_Analytics.CCM.onReady(function(){CQ_Analytics.ClientContextUtils.onStoreRegistered(b,function(){var g=CQ_Analytics.StoreRegistry.getStore(b);if(g){var h=function(){var b=g.getProperty(c)||f,n=$CQ("#"+a);if(!n.attr("contenteditable")||"inherit"==n.attr("contenteditable"))if("string"!=typeof b||(0!=b.indexOf("/")||-1==b.toLowerCase().indexOf(".png")&&-1==b.toLowerCase().indexOf(".jpg")&&
-1==b.toLowerCase().indexOf(".gif"))&&0!=b.toLowerCase().indexOf("http"))b=CQ_Analytics.Variables.replaceVariables(b),b=CQ_Analytics.isUIAvailable?b&&""!=b?b=d+b+e:CQ.I18n.getMessage("No",null,"Ex: No address, No keywords")+" "+c:b&&""!=b?b=d+b+e:"No "+c,n.html()!=b&&!1!==g.fireEvent("beforepropertyrender",g,a)&&(n.html(b),g.fireEvent("propertyrender",g,a));else if(b&&""!=b){var k="";k=0==n.parents(".cq-cc-thumbnail").length||0==b.toLowerCase().indexOf("http")||0==b.indexOf("/libs/wcm/mobile")?b.replace(/&amp;/g,
"\x26"):CQ.shared.HTTP.addParameter("/etc/clientcontext/shared/thumbnail/content.png","path",CQ_Analytics.Variables.replaceVariables(b));k=CQ_Analytics.Variables.replaceVariables(k);-1===(n.find("div").css("background-image")||"").indexOf(k+")")&&!1!==g.fireEvent("beforepropertyrender",g,a)&&generateURLSignature(CQ.shared.HTTP.externalize(k),function(b){n.html("");n.children().remove();$CQ("\x3cdiv\x3e").addClass("cq-cc-thumbnail-img").css("background-image","url("+b+")").appendTo(n);g.fireEvent("propertyrender",
g,a)})}else n.children().remove(),CQ_Analytics.isUIAvailable?n.html(CQ.I18n.getMessage("No",null,"Ex: No address, No keywords")+" "+c):n.html("No "+c)};!1!==g.fireEvent("beforeinitialpropertyrender",g,a)&&(h(),g.addListener&&g.addListener("update",function(){h()}),g.fireEvent("initialpropertyrender",g,a))}})})},renderStore:function(a,b){if(CQ_Analytics&&CQ_Analytics.CCM&&a&&b)CQ_Analytics.CCM.onReady(function(){CQ_Analytics.ClientContextUtils.onStoreRegistered(b,function(){var c=CQ_Analytics.StoreRegistry.getStore(b);
...
function(a){this.teaserInfoButton&&this.teaserInfoButton.hide()})})}function g(a){a.done(function(a){a.teaserToolTip&&(a.teaserToolTip.hide(),a.teaserToolTip.remove(),a.teaserToolTip=null)})}function h(a,b){CQ_Analytics.Engine.stopTeaserLoader(a);l[a]=b}window.CQ_trackTeasersStats=!0;var l={},n={};return{stopTeaserLoader:function(a){if(a=a.path||a){var b=l[a];b&&(CQ_Analytics.SegmentMgr.removeListener("update",b),delete l[a])}},resolveTeaser:function(a,b,c){for(var d=[],e=0,f=0;f<a.length;f++){var g=
a[f],k=g.segments;if(c){var l={teaser:g};c.push(l)}var n=!k||0===k.length;n&&l&&(l.noSegment=!0);!n&&CQ_Analytics.SegmentMgr.resolve(k)&&(n=!0,k&&0<k.length&&!CQ_Analytics.SegmentMgr.segments[k[0]]&&(n=!1,l&&(l.unknownSegment=!0)));n&&(k=CQ_Analytics.SegmentMgr.getMaxBoost(k),l&&(l.boost=k),k===e?d.push(g):k>e&&(d=[],d.push(g),e=k))}a=d;return 0===a.length?null:CQ_Analytics.StrategyMgr.choose(b,a)||a[0]},loadTeaser:function(e){if(a()){var l=CQ.WCM.getEditablePathFromDOM(document.getElementById(e.targetID));
var k=c(l)}var m=ClientContext.get("campaign");m&&m.isCampaignSelected()&&!b||(m=function(){var b=CQ_Analytics.PageDataMgr.getExperience();if(b){CQ_Analytics.PageDataMgr.clearExperience();var c="/_jcr_content/par.html";a()&&(c+="?wcmmode\x3ddisabled");CQ_Analytics.Utils.loadElement(b+c,e.targetID)}else{var x=null;b=function(){var b=null;a()&&(b=[]);var c=ClientContext.get("campaign");if(c&&c.isCampaignSelected()){var l=c.data.path,h=c.data["recipe/path"],p=c.data.campaigns||[];c=e.teasers;for(var v,
m=0;m<c.length;m++)"default"===c[m].name&&(v=c[m]);if(n[e.targetID]&&n[e.targetID][h])var q=n[e.targetID][h];else{if("DEFAULT"===h)q=v;else{for(m=0;m<p.length;m++){var r=p[m];if(p[m].path===l){r=r.experiences;for(var t=0;t<r.length;t++)if(r[t].path===h&&r[t].hasOwnProperty("segments"))for(var w=r[t].segments,y=0;y<w.length;y++);}}for(m=0;m<c.length;m++){h=c[m];if(l=h.hasOwnProperty("segments")&&h.segments.length===w.length)a:if(l=w,h=h.segments,l&&h&&l.length===h.length){l.sort();h.sort();for(p=0;p<
l.length;p++)if(l[p]!==h[p]){l=!1;break a}l=!0}else l=!1;if(l){q=c[m];break}}}q||(q=v);n[e.targetID]={experience:q}}}else q=CQ_Analytics.Engine.resolveTeaser(e.teasers,e.strategy,b);q?x&&x.path===q.path||(x=q,CQ_Analytics.SegmentMgr.fireEvent("teaser-loaded",{campaignPath:q.campaignPath||"",campaignName:q.campainName||"",experiencePath:q.path||"",segmentName:q.title||"",segments:q.segments||[],targetElement:e.targetID}),v=q.url,a()&&(v+="?wcmmode\x3ddisabled"),CQ_Analytics.Utils.loadTeaserElement(v,
e.targetID),window.CQ_trackTeasersStats&&e.trackingURL&&d(q,e.trackingURL),k&&f(k,b,x.path,e.strategy)):(k&&g(k),CQ_Analytics.Utils.clearElement(e.targetID),x=null)};b.call();CQ_Analytics.SegmentMgr&&(l&&h(l,b),CQ_Analytics.SegmentMgr.addListener("update",b));CQ_Analytics.CampaignMgr&&CQ_Analytics.CampaignMgr&&CQ_Analytics.CampaignMgr.addListener("update",b)}},CQ_Analytics.CCM.areStoresInitialized?m.call(this):CQ_Analytics.CCM.addListener("storesinitialize",m))}}}();window.CQ_trackTeasersStats=!0;
function initializeTeaserLoader(a,b,c,d,e,f){d=!(!CQ.Ext||"true"!=d&&!0!==d);if(window.CQ_Analytics){var g=function(){var g="/_jcr_content/par.html";d&&(g+="?wcmmode\x3ddisabled");var l=CQ_Analytics.PageDataMgr.getExperience();if(l)CQ_Analytics.PageDataMgr.clearExperience(),CQ_Analytics.Utils.loadElement(l+g,c);else{var n=null;l=function(){var l=[];if(CQ_Analytics.SegmentMgr)for(var h=0,r=0;r<a.length;r++)if(!a[r].segments||0==a[r].segments.length||!0===CQ_Analytics.SegmentMgr.resolveArray(a[r].segments)){var m=
CQ_Analytics.SegmentMgr.getMaxBoost(a[r].segments);m==h?l.push(a[r]):m>h&&(l=[],l.push(a[r]),h=m)}if(0<l.length){if(h=l[0],CQ_Analytics.StrategyMgr&&(l=CQ_Analytics.StrategyMgr.choose(b,l),null!=l&&(h=l)),!n||n.path!=h.path)if(n=h,l=h.path+g,l=CQ.shared.HTTP.addSelectors(l,CQ.shared.HTTP.getSelectors(window.location.href)),CQ_Analytics.Utils.loadTeaserElement(l,c),window.CQ_trackTeasersStats&&e&&(CQ_Analytics.loadedTeasersStack||(CQ_Analytics.loadedTeasersStack=[],$CQ(window).unload(function(){try{var a=
CQ_Analytics.loadedTeasersStack;if(a){delete CQ_Analytics.loadedTeasersStack;for(var b=e,c=0;c<a.length;c++)b=CQ.shared.HTTP.addParameter(b,"path",a[c]);CQ.shared.HTTP.get(b,function(){})}}catch(B){}})),CQ_Analytics.loadedTeasersStack.push(h.path)),d&&f){var p=CQ.WCM.getEditable(f);p&&(p&&p.teaserToolTip?(p.teaserToolTip.hide(),p.teaserToolTip.remove(),p.teaserToolTip=null):(p.on(CQ.wcm.EditRollover.EVENT_SHOW_HIGHTLIGHT,function(c){this.teaserInfoButton||(this.teaserInfoButton=CQ.Ext.DomHelper.append("CQ",
{tag:"div",cls:"x-tool x-tool-help cq-teaser-tooltip-tool"},!0),this.teaserInfoButton.position("absolute"),this.teaserInfoButton.on("click",function(){if(!p.teaserToolTip){var c=p,d=CQ.Ext.Tip,e=n.path,f="",g=[];if(CQ_Analytics.SegmentMgr)for(var l=0,h=0;h<a.length;h++){var k=CQ.shared.HTTP.externalize(a[h].path+".html");if(a[h].segments&&0!=a[h].segments.length&&!0!==CQ_Analytics.SegmentMgr.resolveArray(a[h].segments))k=[a[h].title,a[h].thumbnail,k],f+=CQ.I18n.getMessage('\x3ca href\x3d"{2}" class\x3d"cq-teaser-segment-link"\x3e\x3cimg src\x3d"{1}" class\x3d"cq-teaser-decision-thumbnail cq-teaser-decision-nomatch"\x3e\x3c/a\x3eExperience: {0} - no match\x3cbr\x3e',
k);else{var m=CQ_Analytics.SegmentMgr.getMaxBoost(a[h].segments);k=[a[h].title,m,a[h].thumbnail,k];f=e==a[h].path?f+CQ.I18n.getMessage('\x3cb\x3e\x3ca href\x3d"{3}" class\x3d"cq-teaser-segment-link"\x3e\x3cimg src\x3d"{2}" class\x3d"cq-teaser-decision-thumbnail cq-teaser-decision-match"\x3e\x3c/a\x3eExperience: {0} - match ( boost \x3d {1} )\x3c/b\x3e\x3cbr\x3e',k):f+CQ.I18n.getMessage('\x3ca href\x3d"{3}" class\x3d"cq-teaser-segment-link"\x3e\x3cimg src\x3d"{2}" class\x3d"cq-teaser-decision-thumbnail cq-teaser-decision-match"\x3e\x3c/a\x3eExperience: {0} - match ( boost \x3d {1} )\x3cbr\x3e',
k);m==l?g.push(a[h]):m>l&&(g=[],g.push(a[h]),l=m)}}f+=CQ.I18n.getMessage("\x3cbr\x3eStrategy \x3cb\x3e{0}\x3c/b\x3e selected current teaser.\x3cbr\x3e",b);c.teaserToolTip=new d({html:f,title:CQ.I18n.getMessage("Selection decision"),width:450,autoHide:!1,closable:!0,height:300,floating:!0,autoHeight:!1,bodyStyle:"overflow-y: scroll;"})}c=this.getXY();p.teaserToolTip.setPosition(c[0]-460,c[1]-100);p.teaserToolTip.show()}));this.teaserInfoButton.anchorTo(c.frameBottom.getEl(),"tr",[-26,-15]);this.teaserInfoButton.show()}),
p.on(CQ.wcm.EditRollover.EVENT_HIDE_HIGHTLIGHT,function(a){this.teaserInfoButton&&this.teaserInfoButton.hide()})))}}else d&&(p=CQ.WCM.getEditable(f))&&p.teaserToolTip&&(p.teaserToolTip.hide(),p.teaserToolTip.remove(),p.teaserToolTip=null),CQ_Analytics.Utils.clearElement(c),n=null};l.call();CQ_Analytics.SegmentMgr&&CQ_Analytics.SegmentMgr.addListener("update",l)}};CQ_Analytics.CCM.areStoresInitialized?g.call(this):CQ_Analytics.CCM.addListener("storesinitialize",g)}}
window.CQ_trackLandingPagesStats=!0;
function initializeLandingPageLoader(a,b,c,d,e){d=CQ.Ext&&("true"==d||!0===d);if(window.CQ_Analytics){var f=function(){var f=null,h=function(){var g=[];if(window.CQ_Analytics&&window.CQ_Analytics.SegmentMgr)for(var h=0,k=0;k<a.length;k++)if(!a[k].segments||0==a[k].segments.length||!0===CQ_Analytics.SegmentMgr.resolveArray(a[k].segments)){var q=CQ_Analytics.SegmentMgr.getMaxBoost(a[k].segments);q==h?g.push(a[k]):q>h&&(g=[],g.push(a[k]),h=q)}if(0<g.length){if(h=g[0],window.CQ_Analytics&&window.CQ_Analytics.StrategyMgr&&
(g=CQ_Analytics.StrategyMgr.choose(b,g),null!=g&&(h=g)),!f||f.path!=h.path){var r=f;f=h;g=CQ.shared.HTTP.get(h.path+".html").responseText;g=function(a,b){if(a&&-1!=a.indexOf('id\x3d"'+b+'"')){b=a.indexOf('id\x3d"'+b+'"');b=a.substring(0,b).lastIndexOf("\x3cdiv");a=a.substring(b);b=a.split(/<div/ig);for(var c=0,d=0;d<b.length;d++){c++;for(var e=b[d].split(/<\/div/ig),f=1;f<e.length;f++)if(c--,1==c)return c=b[d].lastIndexOf("\x3c/div")+6,c=a.indexOf(b[d])+c,a=a.substring(0,c),a=a.substring(a.indexOf("\x3e")+
1,a.lastIndexOf("\x3c/div"))}}return""}(g,c);var m=$CQ("#"+c)[0],p=function(a,b){if(d){b=CQ.WCM.getEditables();for(var c in b){var e=b[c];a&&-1==e.path.indexOf(a)||(e.hide(),e.remove())}}},v=document.createElement("div");v.innerHTML=g;r?($CQ("object",m).parent().fadeOut("slow"),$CQ("img",m).fadeOut("slow"),$CQ(m).slideUp("slow",function(){p(r.path,!1);$CQ(m).children().remove();m.insertBefore(v,m.firstChild);$CQ(m).slideDown("slow",function(){d&&CQ.DOM.executeScripts(CQ.Ext.get(v))})})):(m.insertBefore(v,
m.firstChild),$CQ(m).slideDown("slow",function(){d&&CQ.DOM.executeScripts(CQ.Ext.get(v))}));try{window.CQ_trackLandingPagesStats&&e&&(CQ_Analytics.loadedLandingPagesStack||(CQ_Analytics.loadedLandingPagesStack=[],$CQ(window).unload(function(){try{var a=CQ_Analytics.loadedLandingPagesStack;if(a){delete CQ_Analytics.loadedLandingPagesStack;for(var b=e,c=0;c<a.length;c++)b=CQ.shared.HTTP.addParameter(b,"path",a[c]);CQ.shared.HTTP.get(b,function(){})}}catch(G){}})),CQ_Analytics.loadedLandingPagesStack.push(h.path))}catch(x){}}}else CQ_Analytics.Utils.clearElement(c),
...
d[e],g=b+"/"+e;$CQ.isPlainObject(f)?c(a,g,f):a[g]=f}}function d(a,b,g){for(var e in g)if(g.hasOwnProperty(e)){var f=g[e];if(f.hasOwnProperty("type")&&f.type)for(var n in f)if(f.hasOwnProperty(n)){var k=e+"/"+n;k=b?b+"/"+k:k;$CQ.isPlainObject(f[n])?c(a,k,f[n]):a[k]=f[n]}f.hasOwnProperty("content")&&d(a,b?b+"/"+e:e,f.content)}}b||(this.initProperty={});d(this.initProperty,null,a);this.rawJSON=a});
...
function(a,b){this.data||this.init();var c=this.data;try{var d=a.split(".");for(a=0;a<d.length-1;a++){var e=d[a],f=e.indexOf("["),g=-1;0<f&&(g=parseInt(e.substring(f+1,e.length-1)),e=e.substring(0,f));c=c[e];0<=g&&(c=c[g])}var h=d[d.length-1];if(!b){var l=CQ.shared.XSS.getXSSPropertyName(h);if(c[l])return c[l]}return c[h]}catch(n){}},CQ_Analytics.CartMgr.validate=function(a,b){return"totalPriceFloat"==a?0<=parseFloat(b):0<a.indexOf(".quantity")?0<=parseInt(b):!0},CQ_Analytics.CartMgr.setProperty=
...
(function(a){function b(){}function c(a){k=[a]}function d(a,b,c){return a&&a.apply(b.context||b,c)}function e(e){function p(a){D++||(E(),C&&(l[t]={s:[a]}),I&&(a=I.apply(e,[a])),d(H,e,[a,"success",e]),d(G,e,[e,"success"]))}function x(a){D++||(E(),C&&"timeout"!=a&&(l[t]=a),d(B,e,[e,a]),d(G,e,[e,a]))}e=a.extend({},q,e);var H=e.success,B=e.error,G=e.complete,I=e.dataFilter,A=e.callbackParameter,J=e.callback,M=e.cache,C=e.pageCache,K=e.charset,t=e.url,w=e.data,y=e.timeout,F,D=0,E=b,z;g&&g(function(a){a.done(H).fail(B);
H=a.resolve;B=a.reject}).promise(e);e.abort=function(){!D++&&E()};if(!1===d(e.beforeSend,e,[e])||D)return e;t=t||"";w=w?"string"==typeof w?w:a.param(w,e.traditional):"";t+=w?(/\?/.test(t)?"\x26":"?")+w:"";A&&(t+=(/\?/.test(t)?"\x26":"?")+encodeURIComponent(A)+"\x3d?");M||C||(t+=(/\?/.test(t)?"\x26":"?")+"_"+(new Date).getTime()+"\x3d");t=t.replace(/=\?(&|$)/,"\x3d"+J+"$1");if(C&&(F=l[t]))F.s?p(F.s[0]):x(F);else{f[J]=c;var u=a("\x3cscript\x3e")[0];u.id="_jqjsp"+n++;K&&(u.charset=K);r&&11.6>r.version()?
(z=a("\x3cscript\x3e")[0]).text="document.getElementById('"+u.id+"').onerror()":u.async="async";m&&(u.htmlFor=u.id,u.event="onclick");u.onload=u.onerror=u.onreadystatechange=function(a){if(!u.readyState||!/i/.test(u.readyState)){try{u.onclick&&u.onclick()}catch(N){}a=k;k=0;a?p(a[0]):x("error")}};u.src=t;E=function(a){L&&clearTimeout(L);u.onreadystatechange=u.onload=u.onerror=null;h.removeChild(u);z&&h.removeChild(z)};h.insertBefore(u,A=h.firstChild);z&&h.insertBefore(z,A);var L=0<y&&setTimeout(function(){x("timeout")},
y)}return e}var f=window,g=a.Deferred,h=a("head")[0]||document.documentElement,l={},n=0,k,q={callback:"_jqjsp",url:location.href},r=f.opera,m=!!a("\x3cdiv\x3e").html("\x3c!--[if IE]\x3e\x3ci\x3e\x3c![endif]--\x3e").find("i").length;e.setup=function(b){a.extend(q,b)};a.jsonp=e})(jQuery);
(function(a){a.murmurhash3=function(a,c){var b=a.length&3;var e=a.length-b;var f=c;for(c=0;c<e;){var g=a.charCodeAt(c)&255|(a.charCodeAt(++c)&255)<<8|(a.charCodeAt(++c)&255)<<16|(a.charCodeAt(++c)&255)<<24;++c;g=3432918353*(g&65535)+((3432918353*(g>>>16)&65535)<<16)&4294967295;g=g<<15|g>>>17;g=461845907*(g&65535)+((461845907*(g>>>16)&65535)<<16)&4294967295;f^=g;f=f<<13|f>>>19;f=5*(f&65535)+((5*(f>>>16)&65535)<<16)&4294967295;f=(f&65535)+27492+(((f>>>16)+58964&65535)<<16)}g=0;switch(b){case 3:g^=(a.charCodeAt(c+
2)&255)<<16;case 2:g^=(a.charCodeAt(c+1)&255)<<8;case 1:g^=a.charCodeAt(c)&255,g=3432918353*(g&65535)+((3432918353*(g>>>16)&65535)<<16)&4294967295,g=g<<15|g>>>17,f^=461845907*(g&65535)+((461845907*(g>>>16)&65535)<<16)&4294967295}f^=a.length;f^=f>>>16;f=2246822507*(f&65535)+((2246822507*(f>>>16)&65535)<<16)&4294967295;f^=f>>>13;f=3266489909*(f&65535)+((3266489909*(f>>>16)&65535)<<16)&4294967295;return(f^f>>>16)>>>0}})(jQuery);CQ_Analytics=window.CQ_Analytics||{};
CQ_Analytics.AAM=CQ_Analytics.AAM||{};
CQ_Analytics.AAM.AudienceMgr=CQ_Analytics.AAM.AudienceMgr||function(a){function b(a){var b={};$.each(a,function(a,c){if(g[c.cn]&&(a=g[c.cn],c.dmn.slice(0,a.domain.length)===a.domain)){var d=(a.segkey||"segs")+"\x3d",e=d.length,f=a.valsep||";";$.each(c.cv.split(a.keysep||","),function(a,c){c.slice(0,e)===d&&$.each(c.substring(e).split(f),function(a,c){b[c]=!0})})}});return b}function c(){}function d(a){r={};var b=[];$.each(a,function(a,c){c&&(r[a]=!0,b.push(a))});b.sort();a=m.getProperty("segments");
var c=b.join(",");a!==c&&(m.setProperty("segments",c),k("Set segments to "+c))}function e(a,e){e=e||c;if(n)a.sid?$.getJSON(n,{t:a.sid},function(a){a.segments&&d(a.segments);e();m.fireEvent("update")}).fail(function(a,b,c){q("Failed to resolve segments from AAM server  "+b+" error "+c);e();m.fireEvent("update")}):(e(),m.fireEvent("update"));else{var f={};a=a||{};$.each(a,function(a,b){"sid"===a?f.d_sid=b:f["c_"+a]=b});f.d_nsid=l;f.d_rtbd="json";$.jsonp({url:p,callback:"__aaminvoke",data:f,success:function(a,
c,f){a.stuff&&d(b(a.stuff));e();m.fireEvent("update")},error:function(a,b){q("Failed to retieve json response "+b);e();m.fireEvent("update")}})}}var f=a.partner||"geometrixx",g=a.destinationNames||{CQIntegrationDestination:{domain:".cqclientintegration.adobe.com",segkey:"segs",keysep:",",valsep:";"}},h=a.debug||!1,l=a.containerNSID||"0",n=!1;a.simulationPath&&(n=a.simulationPath+".segments.json");var k=function(){};h&&(k=function(a){console.log("DEBUG: audiencemanager.js "+a)});var q=function(a){console.log("ERROR: audiencemanager.js "+
a)};k("Initialise Audience Manager");var r={},m=CQ_Analytics.JSONStore.getInstance("audiencemgr",null,null,function(){this.init();this.reset()}),p="http://";"https:"==document.location.protocol&&(p="https://");p+=encodeURIComponent(f)+".demdex.net/event?d_cb\x3d?";e(!1,function(){CQ_Analytics.ClientContextMgr.register(m)});m.getUserSegments=function(){return r};m.matches=function(a){return r[a]};m.invoke=e;return m};